...
void l3d_local_kernel_directcp_vec_cpp_helper(const int32_t *nd, const Real *rsc, const Real *cen, const Real *d2max,
    ...
    alignas(64) sctl::StaticArray<Real, 400 * COORD_DIM> buff0;
    alignas(64) sctl::StaticArray<Real, 400 * 1> buff1;
        ...
        for (sctl::Long s = 0; s < Nsrc; s++) {
            ...
            if (digits <= 3) {
                ...
                ptmp = EvalPolynomial(xtmp.get(), coefs[0], coefs[1], coefs[2], coefs[3], coefs[4], coefs[5], coefs[6],
                                      ...
                                      coefs[21], coefs[22], coefs[23], coefs[24]);
            }
...
template <class Real, sctl::Integer MaxVecLen = sctl::DefaultVecLen<Real>(), sctl::Integer digits = -1,
          sctl::Integer ndim>
void l3d_near_kernel_directcp_vec_cpp_helper(const int32_t *nd, const Real *rsc, const Real *cen, const Real *bsizeinv,
                                             const Real *d2max, const Real *sources, const int32_t *ns,
                                             const Real *charge, const Real *xtarg, const Real *ytarg,
                                             const Real *ztarg, const int32_t *nt, Real *pot) {
    static constexpr sctl::Integer COORD_DIM = ndim; // ndim[0];
    constexpr sctl::Long nd_ = 1;                    // nd[0];
    sctl::Long Nsrc = ns[0];
    sctl::Long Ntrg = nt[0];
...
#pragma omp parallel for schedule(static)
    for (sctl::Long t = 0; t < Ntrg_; t += VecLen) {
        ...
        for (sctl::Long s = 0; s < Nsrc; s++) {
            ...
            Vec rtmp;
            if (digits <= 3) {
                constexpr Real coefs[9] = {2.146941209293174e-02,  -6.263795886222773e-02, 8.000991991853681e-02,
                                           -6.788435300350132e-02, 4.424154750495320e-02,  -1.495578200922307e-02,
                                           6.246832281171233e-03,  -1.726850983519235e-02, 1.079907579714659e-02};
                rtmp = EvalPolynomial(xtmp.get(), coefs[0], coefs[1], coefs[2], coefs[3], coefs[4], coefs[5], coefs[6],
                                      coefs[7], coefs[8]);
            } else if (digits <= 6) {
                constexpr Real coefs[16] = {
                ...
                constexpr Real coefs[23] = {
                    7.439068818728897e-05,  -5.262656940614313e-04, 1.747940646794798e-03, -3.655452046318296e-03,
                    5.458534689045880e-03,  -6.274347452854087e-03, 5.861446056118720e-03, -4.651936315076755e-03,
                    3.265895020991306e-03,  -2.116549594822989e-03, 1.295019564795384e-03, -7.104931793603499e-04,
                    3.963779800852606e-04,  -3.715088788968398e-04, 2.481566542480207e-04, 9.891447519677762e-05,
                    -9.709134019402767e-05, -2.149126143671141e-04, 1.548732897108437e-04, 1.000150136693176e-04,
                    -7.093300485336296e-05, -3.465097946298012e-05, 2.257702407959528e-05};
                rtmp = EvalPolynomial(xtmp.get(), coefs[0], coefs[1], coefs[2], coefs[3], coefs[4], coefs[5], coefs[6],
                                      coefs[7], coefs[8], coefs[9], coefs[10], coefs[11], coefs[12], coefs[13],
                                      coefs[14], coefs[15], coefs[16], coefs[17], coefs[18], coefs[19], coefs[20],
                                      coefs[21], coefs[22]);
            } else if (digits <= 12) {
                constexpr Real coefs[30] = {
                    4.096568781361293e-06, -3.795272362992590e-05, 1.673411559121917e-04,  -4.694154825486451e-04,
                    9.456836355880467e-04, -1.465958880864274e-03, 1.831740439198150e-03,  -1.911093729553248e-03,
                    1.714472186521308e-03, -1.357720764610499e-03, 9.725782737362134e-04,  -6.452430396558342e-04,
                    4.062759476187977e-04, -2.464801686610534e-04, 1.415660349296740e-04,  -8.151213564287058e-05,
                    6.088776174428736e-05, -3.897054187608593e-05, -5.199322510991006e-06, 8.621087085929069e-06,
                    3.728698952551457e-05, -2.821687742332601e-05, -2.924205296217508e-05, 2.220073809144907e-05,
                    2.144585933194776e-05, -1.522711053780768e-05, -8.222228416343569e-06, 5.646501904266188e-06,
                    1.761327439453453e-06, -1.149448507931083e-06};
                rtmp = EvalPolynomial(xtmp.get(), coefs[0], coefs[1], coefs[2], coefs[3], coefs[4], coefs[5], coefs[6],
                                      coefs[7], coefs[8], coefs[9], coefs[10], coefs[11], coefs[12], coefs[13],
                                      coefs[14], coefs[15], coefs[16], coefs[17], coefs[18], coefs[19], coefs[20],
                                      coefs[21], coefs[22], coefs[23], coefs[24], coefs[25], coefs[26], coefs[27],
                                      coefs[28], coefs[29]);
            }
...
template <class Real, sctl::Integer MaxVecLen = sctl::DefaultVecLen<Real>()>
void l3d_near_kernel_directcp_vec_cpp(const int32_t *nd, const int32_t *ndim, const int32_t *digits, const Real *rsc,
                                      const Real *cen, const Real *bsizeinv, const Real *d2max, const Real *sources,
                                      const int32_t *ns, const Real *charge, const Real *xtarg, const Real *ytarg,
                                      const Real *ztarg, const int32_t *nt, Real *pot) {
    if (ndim[0] == 3) {
        if (digits[0] <= 3)
            l3d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 3, 3>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                           charge, xtarg, ytarg, ztarg, nt, pot);
        else if (digits[0] <= 6)
            l3d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 6, 3>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                           charge, xtarg, ytarg, ztarg, nt, pot);
        else if (digits[0] <= 9)
            l3d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 9, 3>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                           charge, xtarg, ytarg, ztarg, nt, pot);
        else if (digits[0] <= 12)
            l3d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 12, 3>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                            charge, xtarg, ytarg, ztarg, nt, pot);
        else
            l3d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, -1, 3>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                            charge, xtarg, ytarg, ztarg, nt, pot);
    }
    if (ndim[0] == 2) {
        if (digits[0] <= 3)
            l3d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 3, 2>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                           charge, xtarg, ytarg, ztarg, nt, pot);
        else if (digits[0] <= 6)
            l3d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 6, 2>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                           charge, xtarg, ytarg, ztarg, nt, pot);
        else if (digits[0] <= 9)
            l3d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 9, 2>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                           charge, xtarg, ytarg, ztarg, nt, pot);
        else if (digits[0] <= 12)
            l3d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 12, 2>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                            charge, xtarg, ytarg, ztarg, nt, pot);
        else
            l3d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, -1, 2>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                            charge, xtarg, ytarg, ztarg, nt, pot);
    }
}
...
#pragma omp parallel for schedule(static)
    for (sctl::Long t = 0; t < Ntrg_; t += VecLen) {
        ...
        for (sctl::Long s = 0; s < Nsrc; s++) {
            ...
            Vec ptmp;
            if (digits <= 3) {
                constexpr Real coefs[6] = {1.072550277328770e-01,  -2.940116755817858e-01, 3.195680735052503e-01,
                ...
                constexpr Real coefs[11] = {1.614709231716746e-02,  -8.104482562490173e-02, 1.821202399011004e-01,
                ...
                ptmp = EvalPolynomial(xtmp.get(), coefs[0], coefs[1], coefs[2], coefs[3], coefs[4], coefs[5], coefs[6],
                                      coefs[7], coefs[8], coefs[9], coefs[10]);
            } else if (digits <= 9) {
                constexpr Real coefs[17] = {2.086402113115865e-03,  -1.562089192993565e-02, 5.445041674459949e-02,
                ...
                ptmp = EvalPolynomial(xtmp.get(), coefs[0], coefs[1], coefs[2], coefs[3], coefs[4], coefs[5], coefs[6],
                                      coefs[7], coefs[8], coefs[9], coefs[10], coefs[11], coefs[12], coefs[13],
                                      coefs[14], coefs[15], coefs[16]);
            } else if (digits <= 12) {
                constexpr Real coefs[22] = {
                ...
                ptmp =
                    EvalPolynomial(xtmp.get(), coefs[0], coefs[1], coefs[2], coefs[3], coefs[4], coefs[5], coefs[6],
                                   coefs[7], coefs[8], coefs[9], coefs[10], coefs[11], coefs[12], coefs[13], coefs[14],
...
template <class Real, sctl::Integer MaxVecLen = sctl::DefaultVecLen<Real>(), sctl::Integer digits = -1,
          sctl::Integer ndim>
void sl3d_near_kernel_directcp_vec_cpp_helper(const int32_t *nd, const Real *rsc, const Real *cen, const Real *bsizeinv,
                                              const Real *d2max, const Real *sources, const int32_t *ns,
                                              const Real *charge, const Real *xtarg, const Real *ytarg,
                                              const Real *ztarg, const int32_t *nt, Real *pot) {
    static constexpr sctl::Integer COORD_DIM = ndim; // ndim[0];
...
#pragma omp parallel for schedule(static)
    for (sctl::Long t = 0; t < Ntrg_; t += VecLen) {
        ...
        for (sctl::Long s = 0; s < Nsrc; s++) {
            ...
            Vec rtmp;
            if (digits <= 3) {
                constexpr Real coefs[9] = {8.173887886459996e-02,  -2.451274687320377e-01, 3.277193048641895e-01,
                                           -3.062447627681784e-01, 2.189036013807557e-01,  -5.720936576940738e-02,
                                           1.938154100021000e-02,  -1.170456117266738e-01, 7.803629856633656e-02};
                rtmp = EvalPolynomial(xtmp.get(), coefs[0], coefs[1], coefs[2], coefs[3], coefs[4], coefs[5], coefs[6],
                                      coefs[7], coefs[8]);
            } else if (digits <= 6) {
                constexpr Real coefs[16] = {
                    6.698297444417106e-03,  -3.336488967202680e-02, 7.653327462540263e-02, -1.097982329138708e-01,
                    1.135180590069429e-01,  -9.346163757569020e-02, 6.802392826055811e-02, -4.473461412598995e-02,
                    2.053582116124963e-02,  -1.050937392785068e-02, 2.140236275524626e-02, -1.541390853346769e-02,
                    -8.563795340776453e-03, 6.850981352078830e-03,  6.850974278963085e-03, -4.567316486905559e-03};
                rtmp = EvalPolynomial(xtmp.get(), coefs[0], coefs[1], coefs[2], coefs[3], coefs[4], coefs[5], coefs[6],
                                      coefs[7], coefs[8], coefs[9], coefs[10], coefs[11], coefs[12], coefs[13],
                                      coefs[14], coefs[15]);
            } else if (digits <= 9) {
                constexpr Real coefs[23] = {
                    4.469280876409076e-04,  -3.180300344022710e-03, 1.064042494973956e-02, -2.245742997736247e-02,
                    3.392748565479964e-02,  -3.958160892988580e-02, 3.767970892048522e-02, -3.060599931494992e-02,
                    2.210711084762564e-02,  -1.488479343040319e-02, 9.479554346392999e-03, -5.164827611128249e-03,
                    2.921689534493682e-03,  -3.474436592339673e-03, 2.476406820890942e-03, 1.453581302051929e-03,
                    -1.340755280231744e-03, -2.481010442893649e-03, 1.837785547647935e-03, 1.202914582812853e-03,
                    -8.687714213235775e-04, -4.009715343213927e-04, 2.673143161473490e-04};
                rtmp = EvalPolynomial(xtmp.get(), coefs[0], coefs[1], coefs[2], coefs[3], coefs[4], coefs[5], coefs[6],
                                      coefs[7], coefs[8], coefs[9], coefs[10], coefs[11], coefs[12], coefs[13],
                                      coefs[14], coefs[15], coefs[16], coefs[17], coefs[18], coefs[19], coefs[20],
                                      coefs[21], coefs[22]);
                ...
                constexpr Real coefs[30] = {
                    2.819652392720140e-05, -2.621417646486990e-04, 1.160666482044811e-03,  -3.272221873150037e-03,
                    6.632530755659602e-03, -1.035849178023596e-02, 1.306264335216134e-02,  -1.378426535688983e-02,
                    1.254085460183132e-02, -1.010339264570685e-02, 7.387432833369574e-03,  -5.020801942566828e-03,
                    3.255681802450250e-03, -2.037634681848246e-03, 1.183450016729645e-03,  -6.948989883377235e-04,
                    6.016054650414167e-04, -4.097810677297087e-04, -1.395540857050542e-04, 1.619848136232838e-04,
                    4.871200845424362e-04, -3.817087672355335e-04, -4.033367785609698e-04, 3.126972055405020e-04,
                    2.889390772224942e-04, -2.101222128203517e-04, -1.114695751311956e-04, 7.819135134923272e-05,
                    2.346749533899128e-05, -1.564034027978778e-05};
                rtmp = EvalPolynomial(xtmp.get(), coefs[0], coefs[1], coefs[2], coefs[3], coefs[4], coefs[5], coefs[6],
                                      coefs[7], coefs[8], coefs[9], coefs[10], coefs[11], coefs[12], coefs[13],
                                      coefs[14], coefs[15], coefs[16], coefs[17], coefs[18], coefs[19], coefs[20],
                                      coefs[21], coefs[22], coefs[23], coefs[24], coefs[25], coefs[26], coefs[27],
...
template <class Real, sctl::Integer MaxVecLen = sctl::DefaultVecLen<Real>()>
void sl3d_near_kernel_directcp_vec_cpp(const int32_t *nd, const int32_t *ndim, const int32_t *digits, const Real *rsc,
                                       const Real *cen, const Real *bsizeinv, const Real *d2max, const Real *sources,
                                       const int32_t *ns, const Real *charge, const Real *xtarg, const Real *ytarg,
                                       const Real *ztarg, const int32_t *nt, Real *pot) {
    if (ndim[0] == 3) {
        if (digits[0] <= 3)
            sl3d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 3, 3>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                            charge, xtarg, ytarg, ztarg, nt, pot);
        else if (digits[0] <= 6)
            sl3d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 6, 3>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                            charge, xtarg, ytarg, ztarg, nt, pot);
        else if (digits[0] <= 9)
            sl3d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 9, 3>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                            charge, xtarg, ytarg, ztarg, nt, pot);
        else if (digits[0] <= 12)
            sl3d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 12, 3>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                             charge, xtarg, ytarg, ztarg, nt, pot);
        else
            sl3d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, -1, 3>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                             charge, xtarg, ytarg, ztarg, nt, pot);
    }
    if (ndim[0] == 2) {
        if (digits[0] <= 3)
            sl3d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 3, 2>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                            charge, xtarg, ytarg, ztarg, nt, pot);
        else if (digits[0] <= 6)
            sl3d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 6, 2>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                            charge, xtarg, ytarg, ztarg, nt, pot);
        else if (digits[0] <= 9)
            sl3d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 9, 2>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                            charge, xtarg, ytarg, ztarg, nt, pot);
        else if (digits[0] <= 12)
            sl3d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 12, 2>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                             charge, xtarg, ytarg, ztarg, nt, pot);
        else
            sl3d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, -1, 2>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                             charge, xtarg, ytarg, ztarg, nt, pot);
    }
}
...
#pragma omp parallel for schedule(static)
    for (sctl::Long t = 0; t < Ntrg_; t += VecLen) {
        ...
        for (sctl::Long s = 0; s < Nsrc; s++) {
            ...
            Vec ptmp;
            if (digits <= 3) {
                constexpr Real coefs[5] = {3.293312412035785e-01, -4.329140084314137e-01, 1.366683635926240e-01,
                                           -4.309918126794055e-02, 1.041106682948322e-02};
                ptmp = EvalPolynomial(xtmp.get(), coefs[0], coefs[1], coefs[2], coefs[3], coefs[4]);
            } else if (digits <= 6) {
                constexpr Real coefs[10] = {3.449851438836016e-01,  -4.902921365061905e-01, 2.220880572548949e-01,
                ...
                constexpr Real coefs[15] = {3.464285661408188e-01,  -4.987507216024493e-01, 2.448626056577886e-01,
...
template <class Real, sctl::Integer MaxVecLen = sctl::DefaultVecLen<Real>(), sctl::Integer digits = -1,
          sctl::Integer ndim>
void log_near_kernel_directcp_vec_cpp_helper(const int32_t *nd, const Real *rsc, const Real *cen, const Real *bsizeinv,
                                             const Real *d2max, const Real *sources, const int32_t *ns,
                                             const Real *charge, const Real *xtarg, const Real *ytarg,
                                             const Real *ztarg, const int32_t *nt, Real *pot) {
    static constexpr sctl::Integer COORD_DIM = ndim; // ndim[0];
...
#pragma omp parallel for schedule(static)
    for (sctl::Long t = 0; t < Ntrg_; t += VecLen) {
        ...
        for (sctl::Long s = 0; s < Nsrc; s++) {
            ...
            Vec rtmp;
            if (digits <= 3) {
                constexpr Real coefs[9] = {-6.111367193489408e-03, 2.084211725904822e-02,  -2.814992265313088e-02,
                                           2.317145716583081e-02,  -1.430284775818347e-02, 5.484439507096733e-03,
                                           -2.395905697203788e-03, 4.176782420780789e-03,  -2.438403456299273e-03};
                rtmp = EvalPolynomial(xtmp.get(), coefs[0], coefs[1], coefs[2], coefs[3], coefs[4], coefs[5], coefs[6],
                                      coefs[7], coefs[8]);
            } else if (digits <= 6) {
                constexpr Real coefs[16] = {
                    -3.161280140115538e-04, 1.632058640226754e-03,  -3.844349799468478e-03, 5.577306481275532e-03,
                    -5.721277634228778e-03, 4.559290205715725e-03,  -3.071201618386827e-03, 1.839973139774339e-03,
                    -9.187363825782615e-04, 4.702946355513738e-04,  -4.916708204871587e-04, 3.113194482571232e-04,
                    1.070558573237174e-04,  -8.783390147456941e-05, -1.223387576644629e-04, 7.612193606978956e-05};
                rtmp = EvalPolynomial(xtmp.get(), coefs[0], coefs[1], coefs[2], coefs[3], coefs[4], coefs[5], coefs[6],
                                      coefs[7], coefs[8], coefs[9], coefs[10], coefs[11], coefs[12], coefs[13],
                                      coefs[14], coefs[15]);
            } else if (digits <= 9) {
                constexpr Real coefs[23] = {
                    -1.480526527085856e-05, 1.082575403525449e-04, -3.708464597095037e-04, 7.973459217364091e-04,
                    -1.218840652219571e-03, 1.426110326278787e-03, -1.346497983981166e-03, 1.070950178086426e-03,
                    -7.460456670321969e-04, 4.735956561368585e-04, -2.815377216492961e-04, 1.536203375356456e-04,
                    -8.389205404246250e-05, 6.548395440955711e-05, -4.099342560057078e-05, -8.984326635160672e-06,
                    1.037717522160677e-05,  2.985184255602257e-05, -2.088390732763368e-05, -1.318992946343009e-05,
                    9.188925611986615e-06,  4.773485622111551e-06, -3.037662502869409e-06};
                rtmp = EvalPolynomial(xtmp.get(), coefs[0], coefs[1], coefs[2], coefs[3], coefs[4], coefs[5], coefs[6],
                                      coefs[7], coefs[8], coefs[9], coefs[10], coefs[11], coefs[12], coefs[13],
                                      coefs[14], coefs[15], coefs[16], coefs[17], coefs[18], coefs[19], coefs[20],
                                      coefs[21], coefs[22]);
                ...
                constexpr Real coefs[30] = {
                    -7.165864640578160e-07, 6.809707052032247e-06, -3.076702821749118e-05, 8.831526892853401e-05,
                    -1.817299603051672e-04, 2.870664593138785e-04, -3.644248407478640e-04, 3.848464506263178e-04,
                    -3.478587716561872e-04, 2.760386920690674e-04, -1.969154474120812e-04, 1.292205534423863e-04,
                    -7.985953340655639e-05, 4.731188923708227e-05, -2.676160929679155e-05, 1.503835307815370e-05,
                    -1.006229608427533e-05, 6.142572231615496e-06, -2.491704739248160e-07, -5.618278360449910e-07,
                    -4.572199184794956e-06, 3.401527197667564e-06, 3.337274919079647e-06,  -2.528651319888553e-06,
                    -2.523197146331313e-06, 1.767893834880852e-06, 9.598676342648105e-07,  -6.502428959720419e-07,
                    -2.096821845043451e-07, 1.345351847703569e-07};
                rtmp = EvalPolynomial(xtmp.get(), coefs[0], coefs[1], coefs[2], coefs[3], coefs[4], coefs[5], coefs[6],
                                      coefs[7], coefs[8], coefs[9], coefs[10], coefs[11], coefs[12], coefs[13],
                                      coefs[14], coefs[15], coefs[16], coefs[17], coefs[18], coefs[19], coefs[20],
                                      coefs[21], coefs[22], coefs[23], coefs[24], coefs[25], coefs[26], coefs[27],
...
template <class Real, sctl::Integer MaxVecLen = sctl::DefaultVecLen<Real>()>
void log_near_kernel_directcp_vec_cpp(const int32_t *nd, const int32_t *ndim, const int32_t *digits, const Real *rsc,
                                      const Real *cen, const Real *bsizeinv, const Real *d2max, const Real *sources,
                                      const int32_t *ns, const Real *charge, const Real *xtarg, const Real *ytarg,
                                      const Real *ztarg, const int32_t *nt, Real *pot) {
    if (ndim[0] == 3) {
        if (digits[0] <= 3)
            log_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 3, 3>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                           charge, xtarg, ytarg, ztarg, nt, pot);
        else if (digits[0] <= 6)
            log_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 6, 3>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                           charge, xtarg, ytarg, ztarg, nt, pot);
        else if (digits[0] <= 9)
            log_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 9, 3>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                           charge, xtarg, ytarg, ztarg, nt, pot);
        else if (digits[0] <= 12)
            log_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 12, 3>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                            charge, xtarg, ytarg, ztarg, nt, pot);
        else
            log_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, -1, 3>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                            charge, xtarg, ytarg, ztarg, nt, pot);
    }
    if (ndim[0] == 2) {
        if (digits[0] <= 3)
            log_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 3, 2>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                           charge, xtarg, ytarg, ztarg, nt, pot);
        else if (digits[0] <= 6)
            log_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 6, 2>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                           charge, xtarg, ytarg, ztarg, nt, pot);
        else if (digits[0] <= 9)
            log_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 9, 2>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                           charge, xtarg, ytarg, ztarg, nt, pot);
        else if (digits[0] <= 12)
            log_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 12, 2>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                            charge, xtarg, ytarg, ztarg, nt, pot);
        else
            log_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, -1, 2>(nd, rsc, cen, bsizeinv, d2max, sources, ns,
                                                                            charge, xtarg, ytarg, ztarg, nt, pot);
    }
}
...
#pragma omp parallel for schedule(static)
    for (sctl::Long t = 0; t < Ntrg_; t += VecLen) {
        ...
        for (sctl::Long s = 0; s < Nsrc; s++) {
            ...
            Vec xtmp = FMA(R2, Rinv, cen_vec) * rsc_vec;
            if (digits <= 3) {
                constexpr Real cdiag[10] = {6.099528438109667e-01, -2.047157964842887e-01, -2.113126917088419e-01,
                ...
                constexpr Real coffd[10] = {3.274814701832230e-01,  4.871068566478242e-01, -2.761957322600402e-01,
                ...
                fdiag = EvalPolynomial(xtmp.get(), cdiag[0], cdiag[1], cdiag[2], cdiag[3], cdiag[4], cdiag[5], cdiag[6],
                                       cdiag[7], cdiag[8], cdiag[9], cdiag[10], cdiag[11], cdiag[12], cdiag[13],
                                       cdiag[14], cdiag[15]);
                foffd = EvalPolynomial(xtmp.get(), coffd[0], coffd[1], coffd[2], coffd[3], coffd[4], coffd[5], coffd[6],
                                       coffd[7], coffd[8], coffd[9], coffd[10], coffd[11], coffd[12], coffd[13],
                                       coffd[14], coffd[15]);
            } else if (digits <= 9) {
                ...
                fdiag = EvalPolynomial(xtmp.get(), cdiag[0], cdiag[1], cdiag[2], cdiag[3], cdiag[4], cdiag[5], cdiag[6],
                                       cdiag[7], cdiag[8], cdiag[9], cdiag[10], cdiag[11], cdiag[12], cdiag[13],
                                       cdiag[14], cdiag[15], cdiag[16], cdiag[17], cdiag[18], cdiag[19], cdiag[20],
                                       cdiag[21], cdiag[22], cdiag[23]);
                foffd = EvalPolynomial(xtmp.get(), coffd[0], coffd[1], coffd[2], coffd[3], coffd[4], coffd[5], coffd[6],
                                       coffd[7], coffd[8], coffd[9], coffd[10], coffd[11], coffd[12], coffd[13],
                                       coffd[14], coffd[15], coffd[16], coffd[17], coffd[18], coffd[19], coffd[20],
                                       coffd[21], coffd[22], coffd[23]);
            } else if (digits <= 12) {
                constexpr Real cdiag[30] = {
                ...
                fdiag = EvalPolynomial(xtmp.get(), cdiag[0], cdiag[1], cdiag[2], cdiag[3], cdiag[4], cdiag[5], cdiag[6],
                                       cdiag[7], cdiag[8], cdiag[9], cdiag[10], cdiag[11], cdiag[12], cdiag[13],
                                       cdiag[14], cdiag[15], cdiag[16], cdiag[17], cdiag[18], cdiag[19], cdiag[20],
                                       cdiag[21], cdiag[22], cdiag[23], cdiag[24], cdiag[25], cdiag[26], cdiag[27],
                                       cdiag[28], cdiag[29]);
                foffd = EvalPolynomial(xtmp.get(), coffd[0], coffd[1], coffd[2], coffd[3], coffd[4], coffd[5], coffd[6],
                                       coffd[7], coffd[8], coffd[9], coffd[10], coffd[11], coffd[12], coffd[13],
                                       coffd[14], coffd[15], coffd[16], coffd[17], coffd[18], coffd[19], coffd[20],
                                       coffd[21], coffd[22], coffd[23], coffd[24], coffd[25], coffd[26], coffd[27],
                                       coffd[28], coffd[29], coffd[30]);
            }
            Vec half = 0.5e0;
...
template <class Real, sctl::Integer MaxVecLen = sctl::DefaultVecLen<Real>(), sctl::Integer digits = -1,
          sctl::Integer ndim>
void st3d_near_kernel_directcp_vec_cpp_helper(const int32_t *nd, const Real *rsc, const Real *cen, const Real *bsizeinv,
                                              const Real *d2min, const Real *d2max, const Real *sources,
                                              const int32_t *ns, const Real *stoklet, const Real *xtarg,
                                              const Real *ytarg, const Real *ztarg, const int32_t *nt, Real *pot) {
    static constexpr sctl::Integer COORD_DIM = ndim; // ndim[0];
    constexpr sctl::Long nd_ = 1;                    // nd[0];
    sctl::Long Nsrc = ns[0];
...
#pragma omp parallel for schedule(static)
    for (sctl::Long t = 0; t < Ntrg_; t += VecLen) {
        ...
        for (sctl::Long s = 0; s < Nsrc; s++) {
            ...
            Vec xtmp = FMA(R2, rsc_vec, cen_vec);
            if (digits <= 3) {
                constexpr Real cdiag[8] = {-1.200465301327137e-02, 4.400592204092247e-02,  -7.288597161347318e-02,
                                           6.078910968844339e-02,  -3.108708030232192e-02, 1.003402339570593e-02,
                                           5.363405306153075e-03,  -5.553171339387891e-03};
                constexpr Real coffd[11] = {2.250430121704944e-02,  -9.787611559588733e-02, 2.070217916734389e-01,
                                            -2.524368328199907e-01, 2.259705057475586e-01,  -2.420893817698530e-01,
                                            1.866923371452701e-01,  3.395770252841146e-02,  -4.311241235638091e-02,
                                            -1.308211487415907e-01, 9.152265431281228e-02};

                fdiag = EvalPolynomial(xtmp.get(), cdiag[0], cdiag[1], cdiag[2], cdiag[3], cdiag[4], cdiag[5], cdiag[6],
                                       cdiag[7]);
                foffd = EvalPolynomial(xtmp.get(), coffd[0], coffd[1], coffd[2], coffd[3], coffd[4], coffd[5], coffd[6],
                                       coffd[7], coffd[8], coffd[9], coffd[10]);
            } else if (digits <= 6) {
                constexpr Real cdiag[16] = {
                    -6.778413276129699e-04, 4.066402381071667e-03, -1.124864783439655e-02, 1.920489141603694e-02,
                    -2.281183769709533e-02, 1.999165544932320e-02, -1.322112536620177e-02, 6.698004916394447e-03,
                    -2.867817976329824e-03, 8.503272900193856e-04, 6.879027750537969e-04,  -6.923660302115852e-04,
                    -4.270882823565761e-04, 3.190690821977045e-04, 3.599672200216620e-04,  -2.326863819796524e-04};
                constexpr Real coffd[18] = {1.184705266078750e-03,  -7.928021809420677e-03, 2.512862663913759e-02,
                                            -5.082440691714102e-02, 7.474069197148014e-02,  -8.588843617624770e-02,
                                            7.996358530102793e-02,  -6.499276257962841e-02, 5.539840177127529e-02,
                                            -4.014685171673929e-02, 4.879357438144119e-03,  1.419883695499086e-03,
                                            3.525871341680183e-02,  -2.706860456161926e-02, -1.886722540638105e-02,
                                            1.460477431730375e-02,  9.998150833375779e-03,  -6.859402138560325e-03};
                ...
                foffd = EvalPolynomial(xtmp.get(), coffd[0], coffd[1], coffd[2], coffd[3], coffd[4], coffd[5], coffd[6],
                                       coffd[7], coffd[8], coffd[9], coffd[10], coffd[11], coffd[12], coffd[13],
                                       coffd[14], coffd[15], coffd[16], coffd[17]);
            } else if (digits <= 9) {
                constexpr Real cdiag[23] = {
                    -3.878153424079992e-05, 3.256189735159013e-04,  -1.291899812828380e-03, 3.229916915849101e-03,
                    -5.725266461380479e-03, 7.674125798699759e-03,  -8.098740367932972e-03, 6.913185387623120e-03,
                    -4.856062649177749e-03, 2.823670090265469e-03,  -1.355279681198315e-03, 5.449639991689835e-04,
                    -1.573565756195452e-04, -6.142949960309105e-05, 8.529221725570496e-05,  6.031578891512924e-05,
                    -5.124161335103055e-05, -1.068570833585420e-04, 7.728626890477778e-05,  5.004058618345081e-05,
                    -3.546124492943787e-05, -1.732639740560593e-05, 1.128665971177788e-05};
                constexpr Real coffd[25] = {
                    6.624075337874347e-05, -6.004788860368634e-04, 2.607469373283419e-03,  -7.253882663868505e-03,
                    1.460090147812115e-02, -2.278998801679410e-02, 2.890979755628365e-02,  -3.090332841865437e-02,
                    2.864081241685065e-02, -2.346242023342941e-02, 1.758898775589444e-02,  -1.313353046939937e-02,
                    9.021722692595935e-03, -3.282346255657025e-03, 1.420184381040870e-03,  -6.380299711307833e-03,
                    5.025686336175834e-03, 4.958529166778002e-03,  -4.180405898190081e-03, -5.347809413213879e-03,
                    4.033537744888153e-03, 2.501762336680086e-03,  -1.818842040363272e-03, -6.956860848979441e-04,
                    4.733863147248488e-04};
                ...
                foffd = EvalPolynomial(xtmp.get(), coffd[0], coffd[1], coffd[2], coffd[3], coffd[4], coffd[5], coffd[6],
                                       coffd[7], coffd[8], coffd[9], coffd[10], coffd[11], coffd[12], coffd[13],
                                       coffd[14], coffd[15], coffd[16], coffd[17], coffd[18], coffd[19], coffd[20],
                                       coffd[21], coffd[22], coffd[23], coffd[24]);
            } else if (digits <= 12) {
                constexpr Real cdiag[30] = {
                    -2.365198302088124e-06, 2.532509802787800e-05,  -1.296537952505377e-04, 4.232094084463001e-04,
                    -9.910012567778351e-04, 1.775947306400662e-03,  -2.537394110037294e-03, 2.972748898833850e-03,
                    -2.914410596015076e-03, 2.426822952762970e-03,  -1.734662064238163e-03, 1.070629855889581e-03,
                    -5.701347107608747e-04, 2.599775140854510e-04,  -9.984675852515150e-05, 2.602133849193166e-05,
                    7.916312005211445e-06,  -1.011119573757128e-05, -8.536886328363358e-06, 4.830410119964790e-06,
                    2.259222340348041e-05,  -1.585169034452381e-05, -1.796469429729689e-05, 1.393079426628784e-05,
                    1.248640412589774e-05,  -9.761834712979377e-06, -4.660085362534675e-06, 3.676347054719938e-06,
                    9.569006500073318e-07,  -7.168872115696289e-07};
                constexpr Real coffd[33] = {
                    3.987091389679245e-06, -4.530466653601684e-05, 2.482202699268798e-04,  -8.757112651021776e-04,
                    2.242385653041884e-03, -4.456033431322906e-03, 7.179047693407825e-03,  -9.679175689803102e-03,
                    1.119660676257098e-02, -1.134724857533237e-02, 1.026356197723929e-02,  -8.432004750793295e-03,
                    6.400243446867002e-03, -4.543110589277678e-03, 3.046931278095421e-03,  -2.036384585843810e-03,
                    1.395901058514606e-03, -7.057178364754547e-04, 1.946535621651056e-04,  -5.652424121139273e-04,
                    7.913110889513830e-04, 3.587169277761613e-04,  -8.099287633106095e-04, -6.702740168842681e-04,
                    9.785690594905075e-04, 5.615069843258193e-04,  -7.287094291575096e-04, -3.648193776827285e-04,
                    3.973573611639653e-04, 1.343712111701797e-04,  -1.293553078167434e-04, -2.606246726396383e-05,
                    2.171173793246976e-05};
                ...
                foffd = EvalPolynomial(xtmp.get(), coffd[0], coffd[1], coffd[2], coffd[3], coffd[4], coffd[5], coffd[6],
                                       ...
                                       coffd[14], coffd[15], coffd[16], coffd[17], coffd[18], coffd[19], coffd[20],
                                       coffd[21], coffd[22], coffd[23], coffd[24], coffd[25], coffd[26], coffd[27],
                                       coffd[28], coffd[29], coffd[30], coffd[31], coffd[32]);
            }
...
template <class Real, sctl::Integer MaxVecLen = sctl::DefaultVecLen<Real>()>
void st3d_near_kernel_directcp_vec_cpp(const int32_t *nd, const int32_t *ndim, const int32_t *digits, const Real *rsc,
                                       const Real *cen, const Real *bsizeinv, const Real *d2min, const Real *d2max,
                                       const Real *sources, const int32_t *ns, const Real *charge, const Real *xtarg,
                                       const Real *ytarg, const Real *ztarg, const int32_t *nt, Real *pot) {
    if (digits[0] <= 3)
        st3d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 3, 3>(nd, rsc, cen, bsizeinv, d2min, d2max, sources,
                                                                        ns, charge, xtarg, ytarg, ztarg, nt, pot);
    else if (digits[0] <= 6)
        st3d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 6, 3>(nd, rsc, cen, bsizeinv, d2min, d2max, sources,
                                                                        ns, charge, xtarg, ytarg, ztarg, nt, pot);
    else if (digits[0] <= 9)
        st3d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 9, 3>(nd, rsc, cen, bsizeinv, d2min, d2max, sources,
                                                                        ns, charge, xtarg, ytarg, ztarg, nt, pot);
    else if (digits[0] <= 12)
        st3d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 12, 3>(nd, rsc, cen, bsizeinv, d2min, d2max, sources,
                                                                         ns, charge, xtarg, ytarg, ztarg, nt, pot);
    else
        st3d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, -1, 3>(nd, rsc, cen, bsizeinv, d2min, d2max, sources,
                                                                         ns, charge, xtarg, ytarg, ztarg, nt, pot);
}
...
#pragma omp parallel for schedule(static)
    for (sctl::Long t = 0; t < Ntrg_; t += VecLen) {
        ...
        for (sctl::Long s = 0; s < Nsrc; s++) {
            ...
            Vec xtmp = FMA(R2, rsc_vec, cen_vec);
            if (digits <= 3) {
                constexpr Real cdiag[8] = {1.846554578756552e-01,  -2.966683058873768e-01, 2.187482696883298e-01,
                                           -1.930445665343498e-01, 1.152120060185630e-01,  -4.624359846616554e-02,
                                           3.986446577184038e-02,  -2.296552527129039e-02};
                constexpr Real coffd[8] = {4.874864017381395e-01,  5.299044064212663e-02,  -1.098956047309594e-01,
                ...
                constexpr Real cdiag[13] = {1.742974848578507e-01,  -2.573253389659778e-01, 1.497483703405333e-01,
                ...
                constexpr Real coffd[14] = {4.989275970042895e-01,  7.861971816869706e-03,  -2.698194194185921e-02,
                ...
                fdiag = EvalPolynomial(xtmp.get(), cdiag[0], cdiag[1], cdiag[2], cdiag[3], cdiag[4], cdiag[5], cdiag[6],
                                       cdiag[7], cdiag[8], cdiag[9], cdiag[10], cdiag[11], cdiag[12]);
                foffd = EvalPolynomial(xtmp.get(), coffd[0], coffd[1], coffd[2], coffd[3], coffd[4], coffd[5], coffd[6],
                                       coffd[7], coffd[8], coffd[9], coffd[10], coffd[11], coffd[12], coffd[13]);
            } else if (digits <= 9) {
                constexpr Real cdiag[19] = {
                ...
                fdiag = EvalPolynomial(xtmp.get(), cdiag[0], cdiag[1], cdiag[2], cdiag[3], cdiag[4], cdiag[5], cdiag[6],
                                       cdiag[7], cdiag[8], cdiag[9], cdiag[10], cdiag[11], cdiag[12], cdiag[13],
                                       cdiag[14], cdiag[15], cdiag[16], cdiag[17], cdiag[18]);
                foffd = EvalPolynomial(xtmp.get(), coffd[0], coffd[1], coffd[2], coffd[3], coffd[4], coffd[5], coffd[6],
                                       coffd[7], coffd[8], coffd[9], coffd[10], coffd[11], coffd[12], coffd[13],
                                       coffd[14], coffd[15], coffd[16], coffd[17], coffd[18]);
            } else if (digits <= 12) {
                constexpr Real cdiag[25] = {
                ...
                fdiag = EvalPolynomial(xtmp.get(), cdiag[0], cdiag[1], cdiag[2], cdiag[3], cdiag[4], cdiag[5], cdiag[6],
                                       cdiag[7], cdiag[8], cdiag[9], cdiag[10], cdiag[11], cdiag[12], cdiag[13],
                                       cdiag[14], cdiag[15], cdiag[16], cdiag[17], cdiag[18], cdiag[19], cdiag[20],
                                       cdiag[21], cdiag[22], cdiag[23], cdiag[24]);
                foffd = EvalPolynomial(xtmp.get(), coffd[0], coffd[1], coffd[2], coffd[3], coffd[4], coffd[5], coffd[6],
                                       coffd[7], coffd[8], coffd[9], coffd[10], coffd[11], coffd[12], coffd[13],
                                       coffd[14], coffd[15], coffd[16], coffd[17], coffd[18], coffd[19], coffd[20],
                                       coffd[21], coffd[22], coffd[23], coffd[24]);
            ...
            Vec R2sc = R2 * bsizeinv2_vec;
            Vec Fdiag =
                select((R2 >= d2min_vec) & (R2 <= d2max_vec), -0.25e0 * sctl::veclog(R2sc) - fdiag, Vec::Zero());
...
template <class Real, sctl::Integer MaxVecLen = sctl::DefaultVecLen<Real>(), sctl::Integer digits = -1,
          sctl::Integer ndim>
void st2d_near_kernel_directcp_vec_cpp_helper(const int32_t *nd, const Real *rsc, const Real *cen, const Real *bsizeinv,
                                              const Real *d2min, const Real *d2max, const Real *sources,
                                              const int32_t *ns, const Real *stoklet, const Real *xtarg,
                                              const Real *ytarg, const Real *ztarg, const int32_t *nt, Real *pot) {
    static constexpr sctl::Integer COORD_DIM = ndim; // ndim[0];
...
#pragma omp parallel for schedule(static)
    for (sctl::Long t = 0; t < Ntrg_; t += VecLen) {
        ...
        for (sctl::Long s = 0; s < Nsrc; s++) {
            ...
            Vec xtmp = FMA(R2, rsc_vec, cen_vec);
            if (digits <= 3) {
                constexpr Real cdiag[8] = {-3.998414794184642e-03, 1.324285664942096e-02,  -1.893609240136285e-02,
                                           1.988081279390220e-02,  -1.565735340857958e-02, 6.009474290405808e-03,
                                           1.461928833976798e-03,  -1.654777943685357e-03};
                constexpr Real coffd[10] = {6.825370013492135e-03,  -2.738568594707985e-02, 4.963206753307496e-02,
                                            -6.582798379855469e-02, 8.027100286820954e-02,  -6.519957095909519e-02,
                                            7.550079217492817e-03,  1.268089291030193e-03,  3.828786857898434e-02,
                                            -2.579301318235034e-02};
                ...
                constexpr Real cdiag[15] = {-1.456047650277214e-04, 9.079956726538666e-04,  -2.623397818356276e-03,
                                            4.663208241908292e-03,  -5.730901904803670e-03, 5.200683558903413e-03,
                                            -3.641728717601099e-03, 2.050744701335512e-03,  -8.785210517186211e-04,
                                            1.146038553901061e-04,  7.700211098051572e-05,  1.081512431354119e-04,
                                            -6.706057402490595e-05, -9.559983599910285e-05, 6.069825378925619e-05};
                constexpr Real coffd[18] = {2.429808372877533e-04,  -1.671550929931438e-03, 5.450474945249396e-03,
                                            -1.127345545629040e-02, 1.679652911724135e-02,  -1.944228593275497e-02,
                                            1.827746384664138e-02,  -1.484220332387097e-02, 1.185852189617975e-02,
                                            -8.227913132868213e-03, 2.123327526893051e-03,  -6.471398957193231e-04,
                                            5.603797617073294e-03,  -4.121918190402536e-03, -2.664246417934463e-03,
                                            2.029835104534074e-03,  1.522474967786489e-03,  -1.014967217619112e-03};

                fdiag =
                    EvalPolynomial(xtmp.get(), cdiag[0], cdiag[1], cdiag[2], cdiag[3], cdiag[4], cdiag[5], cdiag[6],
                                   cdiag[7], cdiag[8], cdiag[9], cdiag[10], cdiag[11], cdiag[12], cdiag[13], cdiag[14]);
                foffd = EvalPolynomial(xtmp.get(), coffd[0], coffd[1], coffd[2], coffd[3], coffd[4], coffd[5], coffd[6],
                                       coffd[7], coffd[8], coffd[9], coffd[10], coffd[11], coffd[12], coffd[13],
                                       coffd[14], coffd[15], coffd[16], coffd[17]);
            } else if (digits <= 9) {
                constexpr Real cdiag[22] = {
                    -7.110615341771953e-06, 6.141875873809334e-05,  -2.506676253528090e-04, 6.445589936989885e-04,
                    -1.175033860647445e-03, 1.620124721429269e-03,  -1.759441713321558e-03, 1.546330114969403e-03,
                    -1.119598997773590e-03, 6.758915878568045e-04,  -3.444264068102575e-04, 1.441352916633147e-04,
                    -3.528985235015155e-05, -9.486598365419032e-07, -1.180126115423290e-05, 7.380015531148850e-06,
                    2.069507010796023e-05,  -1.475518926368035e-05, -9.433880958019434e-06, 6.602811307928483e-06,
                    3.757785599178625e-06,  -2.386711531075020e-06};
                constexpr Real coffd[25] = {
                    1.173975955150262e-05, -1.088357519001305e-04, 4.826945683628972e-04,  -1.369185474159939e-03,
                    2.804273486454630e-03, -4.442865965632523e-03, 5.702647228061498e-03,  -6.142361398128255e-03,
                    5.709935004220391e-03, -4.679442074016084e-03, 3.484512488815244e-03,  -2.508099104179134e-03,
                    1.672185985854015e-03, -7.400863791144803e-04, 3.740867712550477e-04,  -9.033823107353169e-04,
                    6.780284981485554e-04, 5.849023635865252e-04,  -4.919195500725383e-04, -6.794312442009345e-04,
                    5.011871121452637e-04, 3.118709922271007e-04,  -2.227512396633936e-04, -8.910545106079971e-05,
                    5.940131461123234e-05};

                fdiag =
                    EvalPolynomial(xtmp.get(), cdiag[0], cdiag[1], cdiag[2], cdiag[3], cdiag[4], cdiag[5], cdiag[6],
                                   cdiag[7], cdiag[8], cdiag[9], cdiag[10], cdiag[11], cdiag[12], cdiag[13], cdiag[14],
                                   cdiag[15], cdiag[16], cdiag[17], cdiag[18], cdiag[19], cdiag[20], cdiag[21]);
                foffd = EvalPolynomial(xtmp.get(), coffd[0], coffd[1], coffd[2], coffd[3], coffd[4], coffd[5], coffd[6],
                                       coffd[7], coffd[8], coffd[9], coffd[10], coffd[11], coffd[12], coffd[13],
                                       coffd[14], coffd[15], coffd[16], coffd[17], coffd[18], coffd[19], coffd[20],
                                       coffd[21], coffd[22], coffd[23], coffd[24]);
                ...
                constexpr Real cdiag[30] = {
                    -3.857407689956136e-07, 4.223762137705732e-06,  -2.211255054653232e-05, 7.380540793879963e-05,
                    -1.767076372234046e-04, 3.237659530274397e-04,  -4.729289704973748e-04, 5.664945924034799e-04,
                    -5.679462362790733e-04, 4.838714850249418e-04,  -3.542882471926727e-04, 2.245805649065638e-04,
                    -1.233427319614584e-04, 5.835230132168445e-05,  -2.405055485496506e-05, 8.294431040922999e-06,
                    1.695951845876735e-07,  -2.690159478561324e-06, -1.654500265729366e-06, 2.730582486100622e-06,
                    3.722435990228163e-06,  -4.236963197620414e-06, -2.930026230415609e-06, 3.253831542690141e-06,
                    1.968228491238935e-06,  -1.917779603045695e-06, -7.142152721166487e-07, 6.456833673045986e-07,
                    1.395323993802861e-07,  -1.120740129435944e-07};
                constexpr Real coffd[32] = {
                    6.329756000924419e-07,  -7.327697464512041e-06, 4.087585448236432e-05, -1.467017507678289e-04,
                    3.817558577488382e-04,  -7.699843732206189e-04, 1.257177653830602e-03, -1.714577678688572e-03,
                    2.001731684123898e-03,  -2.041946413992746e-03, 1.853558605303895e-03, -1.522120939480519e-03,
                    1.146782939466555e-03,  -8.072732448832567e-04, 5.492678428509865e-04, -3.563406094010927e-04,
                    1.887594181488638e-04,  -1.050871686050720e-04, 1.464128935127148e-04, -1.092658069019802e-04,
                    -8.433862896306294e-05, 8.037073345345367e-05,  1.522514982941662e-04, -1.215832904612562e-04,
                    -1.215793564674542e-04, 9.448183907894859e-05,  7.654193769017407e-05, -5.612862382307245e-05,
                    -2.735793161494765e-05, 1.930096294532848e-05,  5.198557164750587e-06, -3.487738839117130e-06};
                ...
                foffd = EvalPolynomial(xtmp.get(), coffd[0], coffd[1], coffd[2], coffd[3], coffd[4], coffd[5], coffd[6],
                                       ...
                                       coffd[14], coffd[15], coffd[16], coffd[17], coffd[18], coffd[19], coffd[20],
                                       coffd[21], coffd[22], coffd[23], coffd[24], coffd[25], coffd[26], coffd[27],
                                       coffd[28], coffd[29], coffd[30], coffd[31]);
            }
...
template <class Real, sctl::Integer MaxVecLen = sctl::DefaultVecLen<Real>()>
void st2d_near_kernel_directcp_vec_cpp(const int32_t *nd, const int32_t *ndim, const int32_t *digits, const Real *rsc,
                                       const Real *cen, const Real *bsizeinv, const Real *d2min, const Real *d2max,
                                       const Real *sources, const int32_t *ns, const Real *charge, const Real *xtarg,
                                       const Real *ytarg, const Real *ztarg, const int32_t *nt, Real *pot) {
    if (digits[0] <= 3)
        st2d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 3, 2>(nd, rsc, cen, bsizeinv, d2min, d2max, sources,
                                                                        ns, charge, xtarg, ytarg, ztarg, nt, pot);
    else if (digits[0] <= 6)
        st2d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 6, 2>(nd, rsc, cen, bsizeinv, d2min, d2max, sources,
                                                                        ns, charge, xtarg, ytarg, ztarg, nt, pot);
    else if (digits[0] <= 9)
        st2d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 9, 2>(nd, rsc, cen, bsizeinv, d2min, d2max, sources,
                                                                        ns, charge, xtarg, ytarg, ztarg, nt, pot);
    else if (digits[0] <= 12)
        st2d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, 12, 2>(nd, rsc, cen, bsizeinv, d2min, d2max, sources,
                                                                         ns, charge, xtarg, ytarg, ztarg, nt, pot);
    else
        st2d_near_kernel_directcp_vec_cpp_helper<Real, MaxVecLen, -1, 2>(nd, rsc, cen, bsizeinv, d2min, d2max, sources,
                                                                         ns, charge, xtarg, ytarg, ztarg, nt, pot);
}
...
#pragma omp parallel for schedule(static)
    for (sctl::Long t = 0; t < Ntrg_; t += VecLen) {
        ...
        for (sctl::Long s = 0; s < Nsrc; s++) {
            ...
            Vec xtmp = FMA(R2, rsc_vec, cen_vec);
            if (digits <= 3) {
                constexpr Real coefs[7] = {9.334285864639144e-01, 2.169971553925394e-01,  -3.006861735844956e-01,
                ...
                constexpr Real coefs[12] = {9.922973647646393e-01,  4.517941536621922e-02,  -1.212953577289340e-01,
                ...
                fres = EvalPolynomial(xtmp.get(), coefs[0], coefs[1], coefs[2], coefs[3], coefs[4], coefs[5], coefs[6],
                                      coefs[7], coefs[8], coefs[9], coefs[10], coefs[11]);
            } else if (digits <= 9) {
                constexpr Real coefs[18] = {9.990603915706698e-01,  7.897602108744739e-03,  -3.122669887520646e-02,
                ...
                fres = EvalPolynomial(xtmp.get(), coefs[0], coefs[1], coefs[2], coefs[3], coefs[4], coefs[5], coefs[6],
                                      coefs[7], coefs[8], coefs[9], coefs[10], coefs[11], coefs[12], coefs[13],
                                      coefs[14], coefs[15], coefs[16], coefs[17]);
            } else if (digits <= 12) {
                constexpr Real coefs[23] = {
