...
namespace SCTL_NAMESPACE { // Generic
  ...
  template <class VData> inline void mask_compress_store_intrin(const Mask<VData>& v, const VData& a, typename VData::ScalarType* s) {
    union U {
        VData v;
        Mask<VData> m;
        typename IntegerType<sizeof(typename VData::ScalarType)>::value q[VData::Size];
    ...
    Integer cnt = 0;
    for (Integer i = 0; i < VData::Size; i++) {s[cnt] = a_.x[i]*(v_.q[i]!=0); cnt += (v_.q[i]!=0);}
  }

  template <class VData> inline VData mask_expand_load_intrin(const Mask<VData>& v, const VData& a, typename VData::ScalarType const* s) {
    union U {
        VData v;
        Mask<VData> m;
        typename IntegerType<sizeof(typename VData::ScalarType)>::value q[VData::Size];
    ...
    Integer cnt = 0;
    for (Integer i = 0; i < VData::Size; i++) {b_.x[i] = s[cnt]*(v_.q[i]!=0)+a_.x[i]*(v_.q[i]==0); cnt+=(v_.q[i]!=0);}
    return b_.v;
  }
  ...
  template <class VData, class CType> VData EvalPolynomial(const VData& x1, const CType& c0, const CType& c1, const CType& c2, const CType& c3, const CType& c4, const CType& c5, const CType& c6, const CType& c7, const CType& c8, const CType& c9, const CType& c10, const CType& c11, const CType& c12, const CType& c13, const CType& c14, const CType& c15) {
	...
	/*	VData v15(fma_intrin<VData>(x1, set1_intrin<VData>(c15), set1_intrin<VData>(c14)));
	VData v13(fma_intrin<VData>(x1, set1_intrin<VData>(c13), set1_intrin<VData>(c12)));
	VData v11(fma_intrin<VData>(x1, set1_intrin<VData>(c11), set1_intrin<VData>(c10)));
	VData v9(fma_intrin<VData>(x1, set1_intrin<VData>(c9), set1_intrin<VData>(c8)));
	VData v7(fma_intrin<VData>(x1, set1_intrin<VData>(c7), set1_intrin<VData>(c6)));
	VData v5(fma_intrin<VData>(x1, set1_intrin<VData>(c5), set1_intrin<VData>(c4)));
	VData v3(fma_intrin<VData>(x1, set1_intrin<VData>(c3), set1_intrin<VData>(c2)));
	VData v1(fma_intrin<VData>(x1, set1_intrin<VData>(c1), set1_intrin<VData>(c0)));

	VData u1513(fma_intrin<VData>(x2,v15,v13));
	VData u1109(fma_intrin<VData>(x2,v11,v9));
	VData u0705(fma_intrin<VData>(x2,v7,v5));
	VData u0301(fma_intrin<VData>(x2,v3,v1));

	VData w2(fma_intrin<VData>(x4,u1513,u1109));
	VData w1(fma_intrin<VData>(x4,u0705,u0301));
	
	return fma_intrin(x8, w2, w1);*/
  ...
  template <class VData, class CType> VData EvalPolynomial(const VData& x1, const CType& c0, const CType& c1, const CType& c2, const CType& c3, const CType& c4, const CType& c5, const CType& c6, const CType& c7, const CType& c8, const CType& c9, const CType& c10, const CType& c11, const CType& c12, const CType& c13, const CType& c14, const CType& c15,const CType& c16,const CType& c17,const CType& c18,const CType& c19) {
    VData x2(mul_intrin<VData>(x1,x1));
    VData x4(mul_intrin<VData>(x2,x2));
    VData x8(mul_intrin<VData>(x4,x4));
    VData x16(mul_intrin<VData>(x8,x8));

    return fma_intrin(x16, fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c19), set1_intrin<VData>(c18)), fma_intrin(x1, set1_intrin<VData>(c17), set1_intrin<VData>(c16))),fma_intrin(x8, fma_intrin(x4, fma_intrin(x2,fma_intrin(x1, set1_intrin<VData>(c15), set1_intrin<VData>(c14)),fma_intrin(x1, set1_intrin<VData>(c13), set1_intrin<VData>(c12))), fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c11), set1_intrin<VData>(c10)), fma_intrin(x1, set1_intrin<VData>(c9), set1_intrin<VData>(c8)))), fma_intrin(x4, fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c7), set1_intrin<VData>(c6)), fma_intrin(x1, set1_intrin<VData>(c5), set1_intrin<VData>(c4))), fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c3), set1_intrin<VData>(c2)), fma_intrin(x1, set1_intrin<VData>(c1), set1_intrin<VData>(c0))))));	
  }
  ...
  template <class VData, class CType> VData EvalPolynomial(const VData& x1, const CType& c0, const CType& c1, const CType& c2, const CType& c3, const CType& c4, const CType& c5, const CType& c6, const CType& c7, const CType& c8, const CType& c9, const CType& c10, const CType& c11, const CType& c12, const CType& c13, const CType& c14, const CType& c15,const CType& c16,const CType& c17,const CType& c18,const CType& c19,const CType& c20) {
    ...
    return fma_intrin(x16,fma_intrin(x4, set1_intrin<VData>(c20), fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c19), set1_intrin<VData>(c18)), fma_intrin(x1, set1_intrin<VData>(c17), set1_intrin<VData>(c16)))),fma_intrin(x8, fma_intrin(x4, fma_intrin(x2,fma_intrin(x1, set1_intrin<VData>(c15), set1_intrin<VData>(c14)),fma_intrin(x1, set1_intrin<VData>(c13), set1_intrin<VData>(c12))), fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c11), set1_intrin<VData>(c10)), fma_intrin(x1, set1_intrin<VData>(c9), set1_intrin<VData>(c8)))), fma_intrin(x4, fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c7), set1_intrin<VData>(c6)), fma_intrin(x1, set1_intrin<VData>(c5), set1_intrin<VData>(c4))), fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c3), set1_intrin<VData>(c2)), fma_intrin(x1, set1_intrin<VData>(c1), set1_intrin<VData>(c0))))));	
  }
  ...
  template <class VData, class CType> VData EvalPolynomial(const VData& x1, const CType& c0, const CType& c1, const CType& c2, const CType& c3, const CType& c4, const CType& c5, const CType& c6, const CType& c7, const CType& c8, const CType& c9, const CType& c10, const CType& c11, const CType& c12, const CType& c13, const CType& c14, const CType& c15,const CType& c16,const CType& c17,const CType& c18,const CType& c19,const CType& c20,const CType& c21,const CType& c22,const CType& c23,const CType& c24,const CType& c25) {
    VData x2(mul_intrin<VData>(x1,x1));
    VData x4(mul_intrin<VData>(x2,x2));
    VData x8(mul_intrin<VData>(x4,x4));
    VData x16(mul_intrin<VData>(x8,x8));

    return fma_intrin(x16,fma_intrin(x8, fma_intrin(x1, set1_intrin<VData>(c25), set1_intrin<VData>(c24)), fma_intrin(x4, fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c23), set1_intrin<VData>(c22)), fma_intrin(x1, set1_intrin<VData>(c21), set1_intrin<VData>(c20))), fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c19), set1_intrin<VData>(c18)), fma_intrin(x1, set1_intrin<VData>(c17), set1_intrin<VData>(c16))))),fma_intrin(x8, fma_intrin(x4, fma_intrin(x2,fma_intrin(x1, set1_intrin<VData>(c15), set1_intrin<VData>(c14)),fma_intrin(x1, set1_intrin<VData>(c13), set1_intrin<VData>(c12))), fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c11), set1_intrin<VData>(c10)), fma_intrin(x1, set1_intrin<VData>(c9), set1_intrin<VData>(c8)))), fma_intrin(x4, fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c7), set1_intrin<VData>(c6)), fma_intrin(x1, set1_intrin<VData>(c5), set1_intrin<VData>(c4))), fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c3), set1_intrin<VData>(c2)), fma_intrin(x1, set1_intrin<VData>(c1), set1_intrin<VData>(c0))))));	
  }
  
  template <class VData, class CType> VData EvalPolynomial(const VData& x1, const CType& c0, const CType& c1, const CType& c2, const CType& c3, const CType& c4, const CType& c5, const CType& c6, const CType& c7, const CType& c8, const CType& c9, const CType& c10, const CType& c11, const CType& c12, const CType& c13, const CType& c14, const CType& c15,const CType& c16,const CType& c17,const CType& c18,const CType& c19,const CType& c20,const CType& c21,const CType& c22,const CType& c23,const CType& c24,const CType& c25,const CType& c26) {
    VData x2(mul_intrin<VData>(x1,x1));
    VData x4(mul_intrin<VData>(x2,x2));
    VData x8(mul_intrin<VData>(x4,x4));
    VData x16(mul_intrin<VData>(x8,x8));

    return fma_intrin(x16,fma_intrin(x8, fma_intrin(x2, set1_intrin<VData>(c26), fma_intrin(x1, set1_intrin<VData>(c25), set1_intrin<VData>(c24))), fma_intrin(x4, fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c23), set1_intrin<VData>(c22)), fma_intrin(x1, set1_intrin<VData>(c21), set1_intrin<VData>(c20))), fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c19), set1_intrin<VData>(c18)), fma_intrin(x1, set1_intrin<VData>(c17), set1_intrin<VData>(c16))))),fma_intrin(x8, fma_intrin(x4, fma_intrin(x2,fma_intrin(x1, set1_intrin<VData>(c15), set1_intrin<VData>(c14)),fma_intrin(x1, set1_intrin<VData>(c13), set1_intrin<VData>(c12))), fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c11), set1_intrin<VData>(c10)), fma_intrin(x1, set1_intrin<VData>(c9), set1_intrin<VData>(c8)))), fma_intrin(x4, fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c7), set1_intrin<VData>(c6)), fma_intrin(x1, set1_intrin<VData>(c5), set1_intrin<VData>(c4))), fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c3), set1_intrin<VData>(c2)), fma_intrin(x1, set1_intrin<VData>(c1), set1_intrin<VData>(c0))))));	
  }
  ...
  template <class VData, class CType> VData EvalRationalFunction(const VData& x1, const CType& c0, const CType& c1, const CType& c2, const CType& c3, const CType& c4, const CType& c5, const CType& d0, const CType& d1, const CType& d2, const CType& d3, const CType& d4) {
    VData x2(mul_intrin<VData>(x1,x1));
    VData x4(mul_intrin<VData>(x2,x2));
    return div_intrin<VData>(fma_intrin(x4, fma_intrin(x1, set1_intrin<VData>(c5), set1_intrin<VData>(c4)), fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(c3), set1_intrin<VData>(c2)), fma_intrin(x1, set1_intrin<VData>(c1), set1_intrin<VData>(c0)))),fma_intrin(x4, add_intrin<VData>(x1, set1_intrin<VData>(d4)), fma_intrin(x2, fma_intrin(x1, set1_intrin<VData>(d3), set1_intrin<VData>(d2)), fma_intrin(x1, set1_intrin<VData>(d1), set1_intrin<VData>(d0)))));
  }
...
namespace SCTL_NAMESPACE { // AVX512
  ...
  template <> inline unsigned mask_popcnt_intrin<VecData<double, 8>>(const Mask<VecData<double, 8>>& v) { return __builtin_popcount(v.v); }
  template <> inline void mask_compress_store_intrin<VecData<double, 8>>(const Mask<VecData<double, 8>>& v, const VecData<double, 8>& a, double* s) { _mm512_mask_compressstoreu_pd(s, v.v, a.v); }
  template <> inline VecData<double, 8> mask_expand_load_intrin<VecData<double, 8>>(const Mask<VecData<double, 8>>& v, const VecData<double, 8>& a, double const* s) { return _mm512_mask_expandloadu_pd(a.v, v.v, s); }
#endif
