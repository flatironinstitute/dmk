...
get_laplace_3d_kernel<float, sctl::DefaultVecLen<float>()>(dmk_eval_type, int, const std::vector<std::vector<float>> &);
template residual_evaluator_func<double>
get_laplace_3d_kernel<double, sctl::DefaultVecLen<double>()>(dmk_eval_type, int,
