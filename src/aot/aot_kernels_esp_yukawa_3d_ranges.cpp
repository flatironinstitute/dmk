...
get_esp_yukawa_3d_kernel_ranges<float, sctl::DefaultVecLen<float>()>(dmk_eval_type, int,
                                                                     const std::vector<std::vector<float>> &);
template residual_evaluator_range_func<double>
get_esp_yukawa_3d_kernel_ranges<double, sctl::DefaultVecLen<double>()>(dmk_eval_type, int,
