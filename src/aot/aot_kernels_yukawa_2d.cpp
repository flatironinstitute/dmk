...
residual_evaluator_func<Real> get_yukawa_2d_kernel(dmk_eval_type eval_level, int n_digits,
...
get_yukawa_2d_kernel<float, sctl::DefaultVecLen<float>()>(dmk_eval_type, int, const std::vector<std::vector<float>> &);
template residual_evaluator_func<double>
get_yukawa_2d_kernel<double, sctl::DefaultVecLen<double>()>(dmk_eval_type, int,
