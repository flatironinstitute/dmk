...
c      
c  
      subroutine get_periodic_kernel_Fourier_transform(ikernel,
     1    rpars,dim,beta,
     2    bsize,npw,hpw,ws,wprolate,nfourier,fhat)
      implicit none
      integer dim,npw,nfourier,ikernel,i
      real *8 rpars(*),beta,bsize,hpw,ws
      real *8 wprolate(*)
      real *8 xi(0:nfourier)
      real *8 fhat(0:nfourier)
      ...
      elseif (ikernel.eq.3) then
         call stokes_periodic_kernel_Fourier_transform(dim,beta,
     1          bsize,xi,wprolate,nfourier+1,fhat)
         do i=0,nfourier
            fhat(i)=fhat(i)*ws
         enddo
      endif
