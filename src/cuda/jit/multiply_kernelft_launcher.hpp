...
extern template void launch_multiply_cd2p_jit<float, 2>(
    JitCache&,
...
extern template void launch_multiply_cd2p_jit<float, 3>(
    JitCache&,
    const dmk::cuda::MultiplyCd2pArgs<float>&,
    cudaStream_t,
    int
...
extern template void launch_multiply_cd2p_jit<double, 2>(
    JitCache&,
...
extern template void launch_multiply_cd2p_jit<double, 3>(
    JitCache&,
    const dmk::cuda::MultiplyCd2pArgs<double>&,
    cudaStream_t,
    int
...
extern template void launch_multiply_stokeslet_3d_jit<float>(
    JitCache&,
...
extern template void launch_multiply_stokeslet_3d_jit<double>(
    JitCache&,
...
extern template void launch_multiply_stresslet_3d_jit<float>(
    JitCache&,
...
extern template void launch_multiply_stresslet_3d_jit<double>(
    JitCache&,
