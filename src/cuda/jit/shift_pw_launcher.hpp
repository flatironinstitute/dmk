...
extern template void launch_shift_pw_jit<float>(JitCache &, const dmk::cuda::ShiftPwArgs<float> &, cudaStream_t, int,
                                                int);

extern template void launch_shift_pw_jit<double>(JitCache &, const dmk::cuda::ShiftPwArgs<double> &, cudaStream_t, int,
                                                 int);

extern template void launch_shift_pw_multilevel_jit<float>(JitCache &,
                                                           const std::vector<dmk::cuda::ShiftPwArgs<float>> &,
                                                           dmk::cuda::ShiftPwArgs<float> *, cudaStream_t, int, int);

extern template void launch_shift_pw_multilevel_jit<double>(JitCache &,
