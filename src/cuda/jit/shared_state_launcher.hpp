...
extern template void launch_accumulate_and_scatter_jit<float>(JitCache &, float *, const float *, const float *,
                                                              const long *, int, long, cudaStream_t, int);

extern template void launch_accumulate_and_scatter_jit<double>(JitCache &, double *, const double *, const double *,
                                                               const long *, int, long, cudaStream_t, int);
...
extern template void launch_scatter_forward_jit<float>(JitCache &, const float *, float *, const long *, long, int,
                                                       cudaStream_t, int);

extern template void launch_scatter_forward_jit<double>(JitCache &, const double *, double *, const long *, long, int,
                                                        cudaStream_t, int);
...
extern template void launch_scatter_forward_stresslet_jit<float>(JitCache &, const float *, const float *, float *,
                                                                 const long *, long, int, cudaStream_t, int);

extern template void launch_scatter_forward_stresslet_jit<double>(JitCache &, const double *, const double *, double *,
                                                                  const long *, long, int, cudaStream_t, int);
