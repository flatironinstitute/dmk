...
extern template void launch_eval_targets_jit<float, 2>(
    JitCache&,
    int,
    int,
...
extern template void launch_eval_targets_jit<float, 3>(
    JitCache&,
    int,
    int,
    const dmk::cuda::EvalTargetsArgs<float>&,
...
extern template void launch_eval_targets_jit<double, 2>(
    JitCache&,
    int,
    int,
...
extern template void launch_eval_targets_jit<double, 3>(
    JitCache&,
    int,
    int,
    const dmk::cuda::EvalTargetsArgs<double>&,
