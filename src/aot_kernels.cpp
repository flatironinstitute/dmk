...
// beta: 5.634
constexpr double laplace_2d_pot_2[] = {3.13982699174314650e-01, -3.96433852452082069e-01, 9.92426154819550377e-02,
                                       -1.90368403844127405e-02, 2.13177249723958250e-03};

// beta: 8.298
constexpr double laplace_2d_pot_3[] = {3.34951846520722518e-01, -4.51425311660508977e-01, 1.58903913746138520e-01,
                                       -5.64403577878143242e-02, 1.42225947874835106e-02};

// beta: 10.962
constexpr double laplace_2d_pot_4[] = {3.42281810696065336e-01,  -4.78096715201645150e-01, 1.97779137306704961e-01,
                                       -8.64773139989030160e-02, 3.29622925119338744e-02,  -1.11027177029749714e-02,
                                       2.66035143382815312e-03};

// beta: 13.626000000000001
constexpr double laplace_2d_pot_5[] = {3.44915842042819665e-01,  -4.89961369975528027e-01, 2.21480836889886956e-01,
                                       -1.14394622555646933e-01, 5.37419473726064301e-02,  -2.20909817502120964e-02,
                                       8.68893222440876058e-03,  -2.38434123821282566e-03};

// beta: 16.29
constexpr double laplace_2d_pot_6[] = {3.45919386101466886e-01,  -4.95402969807283156e-01, 2.34698481783677582e-01,
...
// beta: 18.954
constexpr double laplace_2d_pot_7[] = {3.46309605610155224e-01,  -4.97894142081210078e-01, 2.42004772957524095e-01,
...
constexpr double laplace_2d_pot_8[] = {3.46465542185645459e-01,  -4.99035132663591008e-01, 2.45882072899040793e-01,
...
// beta: 24.282
constexpr double laplace_2d_pot_9[] = {3.46528846828475290e-01,  -4.99557977040003987e-01, 2.47905052833453571e-01,
...
// beta: 26.946
constexpr double laplace_2d_pot_10[] = {3.46554885811630575e-01,  -4.99797464298173455e-01, 2.48944698681241722e-01,
...
constexpr double laplace_2d_pot_11[] = {
...
// beta: 32.274
constexpr double laplace_2d_pot_12[] = {3.46570248057884389e-01,  -4.99957475122443762e-01, 2.49738364433143178e-01,
...
// beta: 8.298
constexpr double laplace_2d_potgrad_2[] = {3.34951846520722518e-01, -4.51425311660508977e-01, 1.58903913746138520e-01,
                                           -5.64403577878143242e-02, 1.42225947874835106e-02};

// beta: 10.962
constexpr double laplace_2d_potgrad_3[] = {3.42281810696065336e-01, -4.74651459773262507e-01, 1.96951614757899657e-01,
                                           -1.00323195712632346e-01, 3.62826089068872537e-02};

// beta: 13.626000000000001
constexpr double laplace_2d_potgrad_4[] = {3.44920176871833295e-01,  -4.90219983293960604e-01, 2.21402436660399077e-01,
                                           -1.12317042749265697e-01, 5.39515154583087644e-02,  -2.62565947730721422e-02,
                                           8.54901943385855297e-03};

// beta: 16.29
constexpr double laplace_2d_potgrad_5[] = {3.45919146747371120e-01,  -4.95384047142610973e-01, 2.34706170592355046e-01,
                                           -1.34397807809615716e-01, 7.43869214863018685e-02,  -3.59269319087820033e-02,
                                           1.55688336432627528e-02,  -6.94127245225856226e-03, 2.07070483110070045e-03};

// beta: 18.954
constexpr double laplace_2d_potgrad_6[] = {3.46309619226133680e-01,  -4.97895496150748407e-01, 2.42004090029895397e-01,
                                           -1.47196123726502925e-01, 9.05047070412784288e-02,  -5.17495022048355055e-02,
                                           2.62131967637819728e-02,  -1.12681604438025513e-02, 4.39461479379333730e-03,
                                           -1.82596802604633943e-03, 5.09123001556730328e-04};

// beta: 21.618000000000002
constexpr double laplace_2d_potgrad_7[] = {
    3.46465481149457910e-01, -4.99035213704342617e-01, 2.45886484874549199e-01, -1.55391599177316514e-01,
    1.02462596819969054e-01, -6.47383266610577351e-02, 3.76085576354126677e-02, -1.93271385037736346e-02,
    8.36278734166737321e-03, -3.41548261498540902e-03, 1.59294342663441973e-03, -4.71139755089500505e-04};

// beta: 24.282
constexpr double laplace_2d_potgrad_8[] = {3.46528850665512644e-01,  -4.99557971203265339e-01, 2.47904675576316513e-01,
                                           -1.60284389745124545e-01, 1.10852186669380140e-01,  -7.54137567285083077e-02,
                                           4.80501777977961828e-02,  -2.79277329972254830e-02, 1.46664049605039516e-02,
                                           -6.79178891989773437e-03, 2.65156392971445214e-03,  -9.95762145246476167e-04,
                                           4.41120395277256163e-04,  -1.23581352878954025e-04};

// beta: 26.946
constexpr double laplace_2d_potgrad_9[] = {
    3.46554885568200022e-01, -4.99797464715029227e-01, 2.48944729926733777e-01, -1.63125430610325223e-01,
    1.16346117020566145e-01, -8.34673676000358272e-02, 5.73934992433824120e-02, -3.66602863413724098e-02,
    2.13335722381460362e-02, -1.12242367670369204e-02, 5.34945914768236112e-03, -2.26116713289325859e-03,
    8.08640041544051520e-04, -2.83489996957455117e-04, 1.20982358147780829e-04, -3.24425792086878738e-05};

// beta: 29.610000000000003
constexpr double laplace_2d_potgrad_10[] = {
    3.46565709690033752e-01, -4.99907196180674807e-01, 2.49472732235752309e-01, -1.64733890638110780e-01,
    1.19837405856051932e-01, -8.92269477344619644e-02, 6.49191707771030607e-02, -4.46942522849713073e-02,
    2.85037127825339652e-02, -1.66172508741440801e-02, 8.78634303670313734e-03, -4.21335541014616639e-03,
    1.84499848592045322e-03, -7.21803536373401776e-04, 2.39519577081180688e-04, -7.93466355841415330e-05,
    3.29838552304927198e-05, -8.53301465494404308e-06};

// beta: 32.274
constexpr double laplace_2d_potgrad_11[] = {
    3.46570248056881580e-01, -4.99957475124544692e-01, 2.49738364634165461e-01, -1.65626336417365100e-01,
    1.21983076976156318e-01, -9.31667024011153533e-02, 7.06771620614555784e-02, -5.15857801392055476e-02,
    3.54021431112935200e-02, -2.24979189600071003e-02, 1.31188627959427633e-02, -6.98198340755974700e-03,
    3.38107130361194053e-03, -1.49471197885863035e-03, 6.08953436306009952e-04, -2.23164376674921648e-04,
    6.94180505045163728e-05, -2.19385702157794088e-05, 8.96075064984597485e-06, -2.24980224020378735e-06};

// beta: 34.938
constexpr double laplace_2d_potgrad_12[] = {
    3.46572164823272910e-01, -4.99980513692721507e-01, 2.49870931711553196e-01, -1.66113309105737461e-01,
    1.23268093600300277e-01, -9.57656964848807024e-02, 7.48757310039966512e-02, -5.71610723384547229e-02,
    4.16176236712104131e-02, -2.84092648952366210e-02, 1.79794296425675494e-02, -1.04803560231989824e-02,
    5.60237892267522169e-03, -2.73762883102217618e-03, 1.23043912347757284e-03, -5.15732666376753556e-04,
    1.93879364035346265e-04, -6.03241512135931950e-05, 1.99639562927792627e-05, -9.13280523063093426e-06,
    2.39517514749880977e-06};
...
residual_evaluator_func<Real> get_laplace_2d_kernel(dmk_eval_type eval_level, int n_digits) {
    ...
    if (eval_level == DMK_POTENTIAL) {
        if (n_digits <= 2) {
            ...
            std::copy_n(laplace_2d_pot_2, NC_TOTAL, coeffs.data());
        ...
        if (n_digits <= 3) {
            ...
            constexpr int NC0 = 5;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_2d_pot_3, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 4) {
            ...
            constexpr int NC0 = 7;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_2d_pot_4, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 5) {
            ...
            constexpr int NC0 = 8;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_2d_pot_5, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 6) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_2d_pot_6, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 7) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_2d_pot_7, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 8) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_2d_pot_8, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 9) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_2d_pot_9, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 10) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_2d_pot_10, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 11) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_2d_pot_11, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 12) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_2d_pot_12, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 2) {
            ...
            constexpr int NC0 = 5;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_2d_potgrad_2, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
        ...
        if (n_digits <= 3) {
            ...
            constexpr int NC0 = 5;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_2d_potgrad_3, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 4) {
            ...
            constexpr int NC0 = 7;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_2d_potgrad_4, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 5) {
            ...
            constexpr int NC0 = 9;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_2d_potgrad_5, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 6) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_2d_potgrad_6, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 7) {
            ...
            constexpr int NC0 = 12;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_2d_potgrad_7, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 8) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_2d_potgrad_8, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 9) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_2d_potgrad_9, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 10) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_2d_potgrad_10, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 11) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_2d_potgrad_11, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 12) {
            ...
            constexpr int NC0 = 21;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_2d_potgrad_12, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
...
// beta: 5.634
constexpr double laplace_3d_pot_2[] = {2.17998183953000496e-01, -5.01498435116888963e-01, 3.38241507826899823e-01,
                                       1.03815575056770545e-03, -5.66276391535132859e-02};

// beta: 8.298
constexpr double laplace_3d_pot_3[] = {1.35676693383068231e-01,  -4.22679758881918444e-01, 4.46694841556203426e-01,
                                       -1.21102947058209454e-01, -8.26625453105883506e-02, 4.40644298701292625e-02};

// beta: 10.962
constexpr double laplace_3d_pot_4[] = {8.61916042476558453e-02,  -3.39357689807749219e-01, 4.95769318253879487e-01,
                                       -2.63353000669118043e-01, -7.92301496463873600e-02, 1.25856582628138036e-01,
                                       -2.76665730002910318e-03, -2.31735239043814184e-02};

// beta: 13.626000000000001
constexpr double laplace_3d_pot_5[] = {5.58390435893019663e-02,  -2.64586084955049261e-01, 4.87356384393162034e-01,
...
// beta: 16.29
constexpr double laplace_3d_pot_6[] = {3.65651153834013268e-02,  -2.02373828741634704e-01, 4.50680962873918789e-01,
...
// beta: 18.954
constexpr double laplace_3d_pot_7[] = {2.41435731559801123e-02,  -1.52729533229260889e-01, 3.98895426171370859e-01,
...
// beta: 21.618000000000002
constexpr double laplace_3d_pot_8[] = {1.60439437296675640e-02,  -1.14126073550636378e-01, 3.41987337192511121e-01,
...
// beta: 24.282
constexpr double laplace_3d_pot_9[] = {
...
// beta: 26.946
constexpr double laplace_3d_pot_10[] = {
...
// beta: 29.610000000000003
constexpr double laplace_3d_pot_11[] = {
...
// beta: 32.274
constexpr double laplace_3d_pot_12[] = {
...
// beta: 8.298
constexpr double laplace_3d_potgrad_2[] = {1.35373393795720692e-01, -4.36907496688934471e-01, 4.49104115534396831e-01,
                                           -6.54190101699606286e-02, -8.50658566475083061e-02};

// beta: 10.962
constexpr double laplace_3d_potgrad_3[] = {8.60612156248130727e-02,  -3.40111927203895936e-01, 4.97659587015112592e-01,
                                           -2.50082439360021058e-01, -8.37086507244033384e-02, 9.08624864724610626e-02};

// beta: 13.626000000000001
constexpr double laplace_3d_potgrad_4[] = {5.58390435893020218e-02,  -2.64717167590847735e-01, 4.87559575065030892e-01,
...
// beta: 16.29
constexpr double laplace_3d_potgrad_5[] = {3.65651153834012990e-02,  -2.02336522120227985e-01, 4.50703044165623401e-01,
...
// beta: 18.954
constexpr double laplace_3d_potgrad_6[] = {2.41435365819562368e-02,  -1.52718808764497921e-01, 3.98897944342020083e-01,
...
// beta: 21.618000000000002
constexpr double laplace_3d_potgrad_7[] = {
...
// beta: 24.282
constexpr double laplace_3d_potgrad_8[] = {1.07159462374928523e-02,  -8.46341793364562833e-02, 2.86172289845876782e-01,
...
// beta: 26.946
constexpr double laplace_3d_potgrad_9[] = {
...
// beta: 29.610000000000003
constexpr double laplace_3d_potgrad_10[] = {
...
// beta: 32.274
constexpr double laplace_3d_potgrad_11[] = {
...
// beta: 34.938
constexpr double laplace_3d_potgrad_12[] = {
...
residual_evaluator_func<Real> get_laplace_3d_kernel(dmk_eval_type eval_level, int n_digits) {
    ...
    if (eval_level == DMK_POTENTIAL) {
        if (n_digits <= 2) {
            ...
            constexpr int NC0 = 5;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_3d_pot_2, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
        ...
        if (n_digits <= 3) {
            ...
            constexpr int NC0 = 6;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_3d_pot_3, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 4) {
            ...
            constexpr int NC0 = 8;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_3d_pot_4, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 5) {
            ...
            constexpr int NC0 = 11;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_3d_pot_5, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 6) {
            ...
            constexpr int NC0 = 13;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_3d_pot_6, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 7) {
            ...
            constexpr int NC0 = 14;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_3d_pot_7, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 8) {
            ...
            constexpr int NC0 = 17;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_3d_pot_8, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 9) {
            ...
            constexpr int NC0 = 19;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_3d_pot_9, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 10) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_3d_pot_10, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 11) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_3d_pot_11, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 12) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_3d_pot_12, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 2) {
            ...
            constexpr int NC0 = 5;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_3d_potgrad_2, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
        ...
        if (n_digits <= 3) {
            ...
            constexpr int NC0 = 6;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_3d_potgrad_3, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 4) {
            ...
            constexpr int NC0 = 9;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_3d_potgrad_4, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 5) {
            ...
            constexpr int NC0 = 11;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_3d_potgrad_5, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 6) {
            ...
            constexpr int NC0 = 13;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_3d_potgrad_6, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 7) {
            ...
            constexpr int NC0 = 16;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_3d_potgrad_7, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 8) {
            ...
            constexpr int NC0 = 17;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_3d_potgrad_8, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 9) {
            ...
            constexpr int NC0 = 20;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_3d_potgrad_9, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 10) {
            ...
            constexpr int NC0 = 22;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_3d_potgrad_10, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 11) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_3d_potgrad_11, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 12) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_3d_potgrad_12, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
...
// beta: 5.634
constexpr double sqrt_laplace_2d_pot_2[] = {2.17998183953000496e-01, -5.01498435116888963e-01, 3.38241507826899823e-01,
                                            1.03815575056770545e-03, -5.66276391535132859e-02};

// beta: 8.298
constexpr double sqrt_laplace_2d_pot_3[] = {1.35676693383068231e-01,  -4.22679758881918444e-01,
                                            4.46694841556203426e-01,  -1.21102947058209454e-01,
                                            -8.26625453105883506e-02, 4.40644298701292625e-02};

// beta: 10.962
constexpr double sqrt_laplace_2d_pot_4[] = {8.61916042476558453e-02,  -3.39357689807749219e-01, 4.95769318253879487e-01,
                                            -2.63353000669118043e-01, -7.92301496463873600e-02, 1.25856582628138036e-01,
                                            -2.76665730002910318e-03, -2.31735239043814184e-02};

// beta: 13.626000000000001
constexpr double sqrt_laplace_2d_pot_5[] = {5.58390435893019663e-02,  -2.64586084955049261e-01, 4.87356384393162034e-01,
                                            -3.84994597954706641e-01, 1.16315189240913750e-02,  1.85666658452653177e-01,
                                            -8.23628275754923894e-02, -3.98393432987490456e-02, 3.31102704081132765e-02,
                                            3.75332824122639758e-03,  -5.57532476536800898e-03};

// beta: 16.29
constexpr double sqrt_laplace_2d_pot_6[] = {3.65651153834013268e-02,  -2.02373828741634704e-01, 4.50680962873918789e-01,
                                            -4.71259094659650657e-01, 1.31151290530008124e-01,  1.97006325911610741e-01,
                                            -1.75941155471667859e-01, -1.49657566484197244e-02, 7.23405502287229746e-02,
                                            -1.16581017499437639e-02, -1.68036765809427453e-02, 3.25068552699544610e-03,
                                            2.00696867284461816e-03};
...
// beta: 18.954
constexpr double sqrt_laplace_2d_pot_7[] = {2.41435731559801123e-02,  -1.52729533229260889e-01, 3.98895426171370859e-01,
                                            -5.19059925199433780e-01, 2.61759703204077210e-01,  1.53278369473923204e-01,
                                            -2.67097148186365596e-01, 5.99652945526592748e-02,  1.00000753621406493e-01,
                                            -5.88930498174368017e-02, -1.92963638496512387e-02, 2.06712499977083665e-02,
                                            1.59403688932523418e-03,  -3.23248151527584038e-03};
...
// beta: 21.618000000000002
constexpr double sqrt_laplace_2d_pot_8[] = {1.60439437296675640e-02,  -1.14126073550636378e-01, 3.41987337192511121e-01,
                                            -5.32522731286782625e-01, 3.82845035891724916e-01,  6.19184951923090338e-02,
                                            -3.28185447928564689e-01, 1.72307149780891899e-01,  8.96059941698951201e-02,
                                            -1.23461528598353215e-01, 7.59229237815524285e-03,  4.44741945776204600e-02,
                                            -1.41898651813544500e-02, -9.64407308797441548e-03, 5.05118678882309890e-03,
...
// beta: 24.282
constexpr double sqrt_laplace_2d_pot_9[] = {
    1.07159462374928523e-02,  -8.46341160946152277e-02, 2.86172402632982548e-01,  -5.18876415012229586e-01,
    4.81152338514268363e-01,  -6.26555153882026178e-02, -3.41806798659518574e-01, 3.02197463492700547e-01,
    2.78618128968503437e-02,  -1.84360855208628632e-01, 6.88980134368040315e-02,  5.65882082276001064e-02,
    -4.62859517784542374e-02, -8.22864098552431034e-03, 1.65706697984436407e-02,  -2.45712876778660994e-04,
...
// beta: 26.946
constexpr double sqrt_laplace_2d_pot_10[] = {
    7.18708237059719791e-03,  -6.23865646673537194e-02, 2.34945455950023613e-01,  -4.86161809063531958e-01,
    5.50172803263395238e-01,  -2.02350858567595993e-01, -3.00904600453594573e-01, 4.23072285773979484e-01,
    -8.85142719163944380e-02, -2.14363943722174016e-01, 1.62465545958938223e-01,  3.54600844428899428e-02,
    -8.91198361553773438e-02, 1.61613561954918085e-02,  2.92803322475974834e-02,  -1.34235174701271848e-02,
...
// beta: 29.610000000000003
constexpr double sqrt_laplace_2d_pot_11[] = {
    4.83699369429514345e-03,  -4.57629949245662096e-02, 1.89944134896976174e-01,  -4.41694820807374988e-01,
    5.88938808524209989e-01,  -3.40295394858704248e-01, -2.09484233544280640e-01, 5.10379535704030496e-01,
    -2.47274179951901069e-01, -1.90310301964979833e-01, 2.70493212718880660e-01,  -3.20750547444539069e-02,
    -1.25666115771994574e-01, 6.59722816074232998e-02,  3.09799838816447737e-02,  -3.60662789129123224e-02,
...
// beta: 32.274
constexpr double sqrt_laplace_2d_pot_12[] = {
    3.26488932883790091e-03,  -3.34334184769561060e-02, 1.51628119161831165e-01,  -3.91438301385976573e-01,
    6.00144886697036140e-01,  -4.63260754695098143e-01, -7.91094654958735960e-02, 5.46372213823562269e-01,
    -4.25336253533089070e-01, -9.77574303076449019e-02, 3.64039081784227669e-01,  -1.51925312083628056e-01,
    -1.30807301807728871e-01, 1.40036061648695781e-01,  5.66849557035009957e-03,  -6.42865124364210422e-02,
...
residual_evaluator_func<Real> get_sqrt_laplace_2d_kernel(dmk_eval_type eval_level, int n_digits) {
    ...
    if (eval_level == DMK_POTENTIAL) {
        if (n_digits <= 2) {
            ...
            constexpr int NC0 = 5;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(sqrt_laplace_2d_pot_2, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
        ...
        if (n_digits <= 3) {
            ...
            constexpr int NC0 = 6;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(sqrt_laplace_2d_pot_3, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                sqrt_laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 4) {
            ...
            constexpr int NC0 = 8;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(sqrt_laplace_2d_pot_4, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                sqrt_laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 5) {
            ...
            constexpr int NC0 = 11;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(sqrt_laplace_2d_pot_5, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                sqrt_laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 6) {
            ...
            constexpr int NC0 = 13;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(sqrt_laplace_2d_pot_6, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                sqrt_laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 7) {
            ...
            constexpr int NC0 = 14;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(sqrt_laplace_2d_pot_7, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                sqrt_laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 8) {
            ...
            constexpr int NC0 = 17;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(sqrt_laplace_2d_pot_8, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                sqrt_laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 9) {
            ...
            constexpr int NC0 = 19;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(sqrt_laplace_2d_pot_9, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                sqrt_laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 10) {
            ...
            constexpr int NC0 = 22;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(sqrt_laplace_2d_pot_10, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                sqrt_laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 11) {
            ...
            constexpr int NC0 = 24;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(sqrt_laplace_2d_pot_11, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                sqrt_laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 12) {
            ...
            constexpr int NC0 = 26;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(sqrt_laplace_2d_pot_12, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                sqrt_laplace_2d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
...
// beta: 5.634
constexpr double sqrt_laplace_3d_pot_2[] = {1.70377350205786732e-01, -3.72069899729749132e-01, 2.99557895721420997e-01,
                                            -1.27633186141294125e-01, 3.00319654889434559e-02};

// beta: 8.298
constexpr double sqrt_laplace_3d_pot_3[] = {7.91978589785346659e-02, -2.45556231979947831e-01,
                                            3.10542894094654409e-01, -2.22210595880110412e-01,
                                            1.10036966003753095e-01, -3.21968345732795563e-02};

// beta: 10.962
constexpr double sqrt_laplace_3d_pot_4[] = {
...
// beta: 13.626000000000001
constexpr double sqrt_laplace_3d_pot_5[] = {
...
// beta: 16.29
constexpr double sqrt_laplace_3d_pot_6[] = {
...
// beta: 18.954
constexpr double sqrt_laplace_3d_pot_7[] = {
...
// beta: 21.618000000000002
constexpr double sqrt_laplace_3d_pot_8[] = {
...
// beta: 24.282
constexpr double sqrt_laplace_3d_pot_9[] = {
...
// beta: 26.946
constexpr double sqrt_laplace_3d_pot_10[] = {
...
// beta: 29.610000000000003
constexpr double sqrt_laplace_3d_pot_11[] = {
...
// beta: 32.274
constexpr double sqrt_laplace_3d_pot_12[] = {
...
residual_evaluator_func<Real> get_sqrt_laplace_3d_kernel(dmk_eval_type eval_level, int n_digits) {
    ...
    if (eval_level == DMK_POTENTIAL) {
        if (n_digits <= 2) {
            ...
            constexpr int NC0 = 5;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(sqrt_laplace_3d_pot_2, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
        ...
        if (n_digits <= 3) {
            ...
            constexpr int NC0 = 6;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(sqrt_laplace_3d_pot_3, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                sqrt_laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 4) {
            ...
            constexpr int NC0 = 8;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(sqrt_laplace_3d_pot_4, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                sqrt_laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 5) {
            ...
            constexpr int NC0 = 10;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(sqrt_laplace_3d_pot_5, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                sqrt_laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 6) {
            ...
            constexpr int NC0 = 11;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(sqrt_laplace_3d_pot_6, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                sqrt_laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 7) {
            ...
            constexpr int NC0 = 13;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(sqrt_laplace_3d_pot_7, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                sqrt_laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 8) {
            ...
            constexpr int NC0 = 15;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(sqrt_laplace_3d_pot_8, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                sqrt_laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 9) {
            ...
            constexpr int NC0 = 17;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(sqrt_laplace_3d_pot_9, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                sqrt_laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 10) {
            ...
            constexpr int NC0 = 19;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(sqrt_laplace_3d_pot_10, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                sqrt_laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 11) {
            ...
            constexpr int NC0 = 20;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(sqrt_laplace_3d_pot_11, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                sqrt_laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 12) {
            ...
            constexpr int NC0 = 22;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(sqrt_laplace_3d_pot_12, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                sqrt_laplace_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
...
constexpr double stokeslet_3d_vel_2[] = {6.46585315157422791e-01, 6.93259814445607997e-02, -5.09262308622825510e-01,
...
constexpr double stokeslet_3d_vel_3[] = {6.30612792618083673e-01, -1.36708458383978965e-01, -3.85338779412424559e-01,
...
constexpr double stokeslet_3d_vel_4[] = {6.13322712563699524e-01,  -2.01624449424386259e-01, -2.32028937577098165e-01,
...
constexpr double stokeslet_3d_vel_5[] = {
...
constexpr double stokeslet_3d_vel_6[] = {
...
constexpr double stokeslet_3d_vel_7[] = {
...
constexpr double stokeslet_3d_vel_8[] = {
...
constexpr double stokeslet_3d_vel_9[] = {
...
constexpr double stokeslet_3d_vel_10[] = {
...
constexpr double stokeslet_3d_vel_11[] = {
...
constexpr double stokeslet_3d_vel_12[] = {
...
residual_evaluator_func<Real> get_stokeslet_3d_kernel(dmk_eval_type eval_level, int n_digits) {
    ...
    if (eval_level == DMK_VELOCITY) {
        if (n_digits <= 2) {
            ...
            constexpr int NC1 = 5;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(stokeslet_3d_vel_2, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
        ...
        if (n_digits <= 3) {
            ...
            constexpr int NC1 = 7;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(stokeslet_3d_vel_3, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                stokeslet_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, NC1, DMK_VELOCITY>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, NC1, coeffs.data(), n_src, r_src, charge, normals,
        ...
        if (n_digits <= 4) {
            ...
            constexpr int NC1 = 9;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(stokeslet_3d_vel_4, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                stokeslet_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, NC1, DMK_VELOCITY>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, NC1, coeffs.data(), n_src, r_src, charge, normals,
        ...
        if (n_digits <= 5) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(stokeslet_3d_vel_5, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                stokeslet_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, NC1, DMK_VELOCITY>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, NC1, coeffs.data(), n_src, r_src, charge, normals,
        ...
        if (n_digits <= 6) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(stokeslet_3d_vel_6, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                stokeslet_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, NC1, DMK_VELOCITY>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, NC1, coeffs.data(), n_src, r_src, charge, normals,
        ...
        if (n_digits <= 7) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(stokeslet_3d_vel_7, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                stokeslet_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, NC1, DMK_VELOCITY>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, NC1, coeffs.data(), n_src, r_src, charge, normals,
        ...
        if (n_digits <= 8) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(stokeslet_3d_vel_8, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                stokeslet_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, NC1, DMK_VELOCITY>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, NC1, coeffs.data(), n_src, r_src, charge, normals,
        ...
        if (n_digits <= 9) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(stokeslet_3d_vel_9, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                stokeslet_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, NC1, DMK_VELOCITY>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, NC1, coeffs.data(), n_src, r_src, charge, normals,
        ...
        if (n_digits <= 10) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(stokeslet_3d_vel_10, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                stokeslet_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, NC1, DMK_VELOCITY>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, NC1, coeffs.data(), n_src, r_src, charge, normals,
        ...
        if (n_digits <= 11) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(stokeslet_3d_vel_11, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                stokeslet_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, NC1, DMK_VELOCITY>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, NC1, coeffs.data(), n_src, r_src, charge, normals,
        ...
        if (n_digits <= 12) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(stokeslet_3d_vel_12, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                stokeslet_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, NC1, DMK_VELOCITY>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, NC1, coeffs.data(), n_src, r_src, charge, normals,
...
// beta: 7.330382858376184
constexpr double stresslet_3d_vel_2[] = {-4.16204699764625152e-01, -6.04264155268749770e-01, 5.28850164523664179e-01,
...
// beta: 10.471975511965976
constexpr double stresslet_3d_vel_3[] = {
...
// beta: 12.566370614359172
constexpr double stresslet_3d_vel_4[] = {-4.94652564695905295e-01, 3.14907038059517794e-02,  1.70965189099022097e+00,
...
// beta: 14.660765716752367
constexpr double stresslet_3d_vel_5[] = {
...
// beta: 17.80235837034216
constexpr double stresslet_3d_vel_6[] = {
...
// beta: 19.896753472735355
constexpr double stresslet_3d_vel_7[] = {
...
// beta: 23.03834612632515
constexpr double stresslet_3d_vel_8[] = {
...
// beta: 25.132741228718345
constexpr double stresslet_3d_vel_9[] = {
...
// beta: 28.274333882308134
constexpr double stresslet_3d_vel_10[] = {
...
// beta: 30.36872898470133
constexpr double stresslet_3d_vel_11[] = {
...
// beta: 33.510321638291124
constexpr double stresslet_3d_vel_12[] = {
...
residual_evaluator_func<Real> get_stresslet_3d_kernel(dmk_eval_type eval_level, int n_digits) {
    ...
    if (eval_level == DMK_VELOCITY) {
        if (n_digits <= 2) {
            ...
            constexpr int NC1 = 5;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(stresslet_3d_vel_2, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
        ...
        if (n_digits <= 3) {
            ...
            constexpr int NC1 = 7;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(stresslet_3d_vel_3, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                stresslet_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, NC1, DMK_VELOCITY>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, NC1, coeffs.data(), n_src, r_src, charge, normals,
        ...
        if (n_digits <= 4) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(stresslet_3d_vel_4, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                stresslet_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, NC1, DMK_VELOCITY>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, NC1, coeffs.data(), n_src, r_src, charge, normals,
        ...
        if (n_digits <= 5) {
            ...
            constexpr int NC1 = 12;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(stresslet_3d_vel_5, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                stresslet_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, NC1, DMK_VELOCITY>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, NC1, coeffs.data(), n_src, r_src, charge, normals,
        ...
        if (n_digits <= 6) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(stresslet_3d_vel_6, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                stresslet_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, NC1, DMK_VELOCITY>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, NC1, coeffs.data(), n_src, r_src, charge, normals,
        ...
        if (n_digits <= 7) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(stresslet_3d_vel_7, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                stresslet_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, NC1, DMK_VELOCITY>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, NC1, coeffs.data(), n_src, r_src, charge, normals,
        ...
        if (n_digits <= 8) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(stresslet_3d_vel_8, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                stresslet_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, NC1, DMK_VELOCITY>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, NC1, coeffs.data(), n_src, r_src, charge, normals,
        ...
        if (n_digits <= 9) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(stresslet_3d_vel_9, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                stresslet_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, NC1, DMK_VELOCITY>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, NC1, coeffs.data(), n_src, r_src, charge, normals,
        ...
        if (n_digits <= 10) {
            ...
            constexpr int NC1 = 25;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(stresslet_3d_vel_10, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                stresslet_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, NC1, DMK_VELOCITY>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, NC1, coeffs.data(), n_src, r_src, charge, normals,
        ...
        if (n_digits <= 11) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(stresslet_3d_vel_11, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                stresslet_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, NC1, DMK_VELOCITY>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, NC1, coeffs.data(), n_src, r_src, charge, normals,
        ...
        if (n_digits <= 12) {
            ...
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(stresslet_3d_vel_12, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                stresslet_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, NC1, DMK_VELOCITY>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, NC1, coeffs.data(), n_src, r_src, charge, normals,
...
// beta: 8.298
constexpr double laplace_dipole_3d_pot_2[] = {1.35373393795720692e-01, -4.36907496688934471e-01,
                                              4.49104115534396831e-01, -6.54190101699606286e-02,
                                              -8.50658566475083061e-02};

// beta: 10.962
constexpr double laplace_dipole_3d_pot_3[] = {8.60612156248130727e-02,  -3.40111927203895936e-01,
                                              4.97659587015112592e-01,  -2.50082439360021058e-01,
                                              -8.37086507244033384e-02, 9.08624864724610626e-02};

// beta: 13.626000000000001
constexpr double laplace_dipole_3d_pot_4[] = {
    5.58390435893020218e-02,  -2.64717167590847735e-01, 4.87559575065030892e-01,
    -3.83241492306865494e-01, 8.96132752589977148e-03,  1.79344646567271587e-01,
    -7.28417849593808592e-02, -3.14007565336095265e-02, 2.05017147121834692e-02};

// beta: 16.29
constexpr double laplace_dipole_3d_pot_5[] = {
...
// beta: 18.954
constexpr double laplace_dipole_3d_pot_6[] = {
...
// beta: 21.618000000000002
constexpr double laplace_dipole_3d_pot_7[] = {
    1.60439680211329795e-02,  -1.14126099610511914e-01, 3.41984271196447198e-01,  -5.32521756854699824e-01,
    3.82908730215659632e-01,  6.19079603329049238e-02,  -3.28690650132687112e-01, 1.72357352569426858e-01,
    9.15769080873981428e-02,  -1.23584312439697891e-01, 3.41197217941373396e-03,  4.46349951564157174e-02,
    -9.27357818320668700e-03, -9.75130738557921685e-03, 2.03839781997119636e-03,  1.08317173001665928e-03};
...
// beta: 24.282
constexpr double laplace_dipole_3d_pot_8[] = {
...
// beta: 26.946
constexpr double laplace_dipole_3d_pot_9[] = {
    7.18708246440367265e-03,  -6.23865649137638756e-02, 2.34945437005272401e-01,  -4.86161760244670338e-01,
    5.50173433125147771e-01,  -2.02352457277721304e-01, -3.00912710492949653e-01, 4.23092619570351436e-01,
    -8.84613031406586287e-02, -2.14495407348589684e-01, 1.62267009118026828e-01,  3.59486417552733750e-02,
    -8.86671064485698157e-02, 1.50553796593915507e-02,  2.86417091603183814e-02,  -1.18732171211611646e-02,
...
// beta: 29.610000000000003
constexpr double laplace_dipole_3d_pot_10[] = {
    4.83699364701164342e-03,  -4.57629949453203164e-02, 1.89944146189103547e-01,  -4.41694815805404428e-01,
    5.88938361753583606e-01,  -3.40295594190500927e-01, -2.09477327720605233e-01, 5.10382635298455400e-01,
    -2.47328995077170849e-01, -1.90335030062067756e-01, 2.70747291815721935e-01,  -3.19599348895081709e-02,
    -1.26400907973926058e-01, 6.56380950546598396e-02,  3.23455685814820898e-02,  -3.54431405368228966e-02,
...
// beta: 32.274
constexpr double laplace_dipole_3d_pot_11[] = {
    3.26488932935758936e-03,  -3.34334184589342026e-02, 1.51628119013288543e-01,  -3.91438303230557672e-01,
    6.00144893739365637e-01,  -4.63260698656872971e-01, -7.91095963485347747e-02, 5.46371422708288978e-01,
    -4.25334996766092766e-01, -9.77511664059468321e-02, 3.64031957093882585e-01,  -1.51956009896253158e-01,
    -1.30781688719692979e-01, 1.40134444080656562e-01,  5.60786571449403779e-03,  -6.44986132385584748e-02,
...
// beta: 34.938
constexpr double laplace_dipole_3d_pot_12[] = {
    2.20928059493365235e-03,  -2.43426875242211231e-02, 1.19761893706071723e-01,  -3.39856659040368825e-01,
    5.88505140797872417e-01,  -5.62618110858054132e-01, 7.48570909907567972e-02,  5.22999143696575630e-01,
    -5.95015655106605257e-01, 6.28415423705892401e-02,  4.10829665279586365e-01,  -3.12678103311007982e-01,
    -7.88556227096840062e-02, 2.21754901069865118e-01,  -6.05635485305918708e-02, -8.38912139235251930e-02,
...
// beta: 10.962
constexpr double laplace_dipole_3d_potgrad_2[] = {8.62385196222487382e-02, -3.69606890598850102e-01,
                                                  4.96528359242903339e-01, -1.35056019181326203e-01,
                                                  -8.26655143090101602e-02};

// beta: 13.626000000000001
constexpr double laplace_dipole_3d_potgrad_3[] = {
...
// beta: 16.29
constexpr double laplace_dipole_3d_potgrad_4[] = {
...
// beta: 18.954
constexpr double laplace_dipole_3d_potgrad_5[] = {
...
// beta: 21.618000000000002
constexpr double laplace_dipole_3d_potgrad_6[] = {
...
// beta: 24.282
constexpr double laplace_dipole_3d_potgrad_7[] = {
...
// beta: 26.946
constexpr double laplace_dipole_3d_potgrad_8[] = {
...
// beta: 29.610000000000003
constexpr double laplace_dipole_3d_potgrad_9[] = {
...
// beta: 32.274
constexpr double laplace_dipole_3d_potgrad_10[] = {
...
// beta: 34.938
constexpr double laplace_dipole_3d_potgrad_11[] = {
...
constexpr double laplace_dipole_3d_potgrad_12[] = {
...
residual_evaluator_func<Real> get_laplace_dipole_3d_kernel(dmk_eval_type eval_level, int n_digits) {
    ...
    if (eval_level == DMK_POTENTIAL) {
        if (n_digits <= 2) {
            ...
            constexpr int NC0 = 5;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_dipole_3d_pot_2, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
        ...
        if (n_digits <= 3) {
            ...
            constexpr int NC0 = 6;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_dipole_3d_pot_3, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_dipole_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 4) {
            ...
            constexpr int NC0 = 9;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_dipole_3d_pot_4, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_dipole_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 5) {
            ...
            constexpr int NC0 = 11;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_dipole_3d_pot_5, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_dipole_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 6) {
            ...
            constexpr int NC0 = 13;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_dipole_3d_pot_6, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_dipole_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 7) {
            ...
            constexpr int NC0 = 16;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_dipole_3d_pot_7, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_dipole_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 8) {
            ...
            constexpr int NC0 = 17;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_dipole_3d_pot_8, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_dipole_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 9) {
            ...
            constexpr int NC0 = 20;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_dipole_3d_pot_9, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_dipole_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 10) {
            ...
            constexpr int NC0 = 22;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_dipole_3d_pot_10, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_dipole_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 11) {
            ...
            constexpr int NC0 = 25;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_dipole_3d_pot_11, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_dipole_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 12) {
            ...
            constexpr int NC0 = 27;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_dipole_3d_pot_12, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_dipole_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 2) {
            ...
            constexpr int NC0 = 5;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_dipole_3d_potgrad_2, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
        ...
        if (n_digits <= 3) {
            ...
            constexpr int NC0 = 7;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_dipole_3d_potgrad_3, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_dipole_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 4) {
            ...
            constexpr int NC0 = 9;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_dipole_3d_potgrad_4, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_dipole_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 5) {
            ...
            constexpr int NC0 = 12;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_dipole_3d_potgrad_5, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_dipole_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 6) {
            ...
            constexpr int NC0 = 14;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_dipole_3d_potgrad_6, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_dipole_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 7) {
            ...
            constexpr int NC0 = 16;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_dipole_3d_potgrad_7, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_dipole_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 8) {
            ...
            constexpr int NC0 = 18;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_dipole_3d_potgrad_8, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_dipole_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 9) {
            ...
            constexpr int NC0 = 20;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_dipole_3d_potgrad_9, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_dipole_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 10) {
            ...
            constexpr int NC0 = 23;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_dipole_3d_potgrad_10, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_dipole_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 11) {
            ...
            constexpr int NC0 = 25;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_dipole_3d_potgrad_11, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_dipole_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
        ...
        if (n_digits <= 12) {
            ...
            constexpr int NC0 = 27;
            std::array<Real, NC_TOTAL> coeffs;
            std::copy_n(laplace_dipole_3d_potgrad_12, NC_TOTAL, coeffs.data());
            return [=](Real rsc, Real cen, Real d2max, Real thresh2, int n_src, const Real *r_src, const Real *charge,
                       const Real *normals, int n_trg, const Real *r_trg, Real *pot) {
                laplace_dipole_3d_poly_all_pairs<Real, MaxVecLen, ND, NC0, DMK_POTENTIAL_GRAD>(
                    eval_level, ND, rsc, cen, d2max, thresh2, NC0, coeffs.data(), n_src, r_src, charge, normals, n_trg,
