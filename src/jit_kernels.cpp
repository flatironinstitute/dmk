...
template void sqrt_laplace_2d_poly_all_pairs<float, VECDIMF>(int nd, int n_digits, float rsc, const float cen,
                                                             ...
                                                             const float *charge, const float *normals, int n_trg,
...
template void laplace_2d_poly_all_pairs<float, VECDIMF>(int nd, int n_digits, float rsc, const float cen, float d2max,
                                                        ...
                                                        const float *r_src, const float *charge, const float *normals,
                                                        int n_trg, const float *r_trg, float *pot, int unroll_factor);
...
template void yukawa_2d_poly_all_pairs<float, VECDIMF>(int eval_level_rt, int n_digits_rt, float rsc, float cen,
                                                       float d2max, float thresh2, int n_coeffs_log_rt,
                                                       int n_coeffs_reg_rt, const float *coeffs, int n_src,
                                                       const float *r_src, const float *charge, const float *normals,
                                                       int n_trg, const float *r_trg, float *pot, int unroll_factor);
template void yukawa_2d_poly_all_pairs<double, VECDIMD>(int eval_level_rt, int n_digits_rt, double rsc, double cen,
                                                        double d2max, double thresh2, int n_coeffs_log_rt,
                                                        int n_coeffs_reg_rt, const double *coeffs, int n_src,
                                                        const double *r_src, const double *charge,
                                                        const double *normals, int n_trg, const double *r_trg,
                                                        double *pot, int unroll_factor);

template void laplace_3d_poly_all_pairs_ranges<float, VECDIMF>(int nd, int n_digits, float rsc, float cen, float d2max,
                                                               float thresh2, int n_coeffs, const float *coeffs,
                                                               int n_ranges, const int *range_starts,
                                                               const int *range_lens, int n_src, const float *r_src,
                                                               const float *charge, const float *normals, int n_trg,
                                                               const float *r_trg, float *pot, const float *q_trg,
                                                               float *pot_src, int unroll_factor);
template void laplace_3d_poly_all_pairs_ranges<double, VECDIMD>(
...
template void sqrt_laplace_3d_poly_all_pairs_ranges<float, VECDIMF>(
    ...
    int unroll_factor);
template void sqrt_laplace_3d_poly_all_pairs_ranges<double, VECDIMD>(
    int nd, int n_digits, double rsc, double cen, double d2max, double thresh2, int n_coeffs, const double *coeffs,
    int n_ranges, const int *range_starts, const int *range_lens, int n_src, const double *r_src, const double *charge,
    const double *normals, int n_trg, const double *r_trg, double *pot, const double *q_trg, double *pot_src,
    int unroll_factor);
...
template void stresslet_3d_poly_all_pairs<float, VECDIMF>(int nd, int n_digits, float rsc, const float cen, float d2max,
                                                          ...
                                                          const float *charge, const float *normals, int n_trg,
                                                          const float *r_trg, float *pot, int unroll_factor);
template void stresslet_3d_poly_all_pairs<double, VECDIMD>(int nd, int n_digits, double rsc, const double cen,
                                                           double d2max, double thresh2, int n_coeffs_diag,
                                                           int n_coeffs_offdiag, const double *coeffs, int n_src,
                                                           const double *r_src, const double *charge,
                                                           const double *normals, int n_trg, const double *r_trg,
...
template void laplace_dipole_2d_poly_all_pairs<float, VECDIMF>(int nd, int n_digits, float rsc, const float cen,
                                                               ...
                                                               const float *charge, const float *normals, int n_trg,
                                                               const float *r_trg, float *pot, int unroll_factor);
template void laplace_dipole_2d_poly_all_pairs<double, VECDIMD>(int nd, int n_digits, double rsc, const double cen,
                                                                double d2max, double thresh2, int n_coeffs,
                                                                const double *coeffs, int n_src, const double *r_src,
                                                                const double *charge, const double *normals, int n_trg,
                                                                const double *r_trg, double *pot, int unroll_factor);

template void laplace_dipole_3d_poly_all_pairs<float, VECDIMF>(int nd, int n_digits, float rsc, const float cen,
                                                               float d2max, float thresh2, int n_coeffs,
                                                               const float *coeffs, int n_src, const float *r_src,
                                                               const float *charge, const float *normals, int n_trg,
                                                               const float *r_trg, float *pot, int unroll_factor);
template void laplace_dipole_3d_poly_all_pairs<double, VECDIMD>(int nd, int n_digits, double rsc, const double cen,
                                                                double d2max, double thresh2, int n_coeffs,
                                                                const double *coeffs, int n_src, const double *r_src,
                                                                const double *charge, const double *normals, int n_trg,
                                                                const double *r_trg, double *pot, int unroll_factor);
