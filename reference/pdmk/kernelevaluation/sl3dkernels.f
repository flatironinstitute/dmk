c      This file contains the direct evaluation kernels for 3D sqrt Laplacian 
c
c      sl3ddirectcp: direct calculation of potential for a collection
...
c
C***********************************************************************
      subroutine sl3ddirectcp(ndim,nd,sources,charge,ns,ztarg,nt,
     1            pot,thresh)
c**********************************************************************
c
