...
// (https://github.com/jodesarro/bessel-library) MIT License Copyright (c) 2021 Jhonas Olivati de Sarro
// (https://github.com/jodesarro/bessel-library/blob/main/LICENSE)
...
//  - Routines zairy_, zbesh_, zbesj_, zbesy_, zbesi_, zbesk_ and zbiry_, based on version 930101 of D. E. Amos routines
//  (https://doi.org/10.1145/7921.214331, ACM domain)
//      were changed (reverted) to be based on slatec ([3], public domain) versions to avoid copyright conflicts between
//      ACM and MIT licenses and permissions. The versions 0.1.1 and 0.1.2 of this code, and github commits related to
//      them, shall be deleted and must be disconsidered and discarded by all users.
...
// 0.1.1 May 27, 2024
//  - Routines zairy_, zbesh_, zbesj_, and zbesy_, updated to the version 930101 of D. E. Amos routines
//  (https://doi.org/10.1145/7921.214331).
//  - Inclusion of routines zbesi_, zbesk_, zbiry_ accordingly to version 930101 of D. E. Amos routines
//  (https://doi.org/10.1145/7921.214331).
...
//  - D. E. Amos routines zairy_.f, zbesh_.f, zbesj_.f, zbesy_.f, and all their dependencies, were converted to C using
//  f2c (Availabe at: https://www.netlib.org/f2c/. Accessed: May 25, 2024).
...
//  - Now, cyl, Bessel functions of the first and second kinds, cyl_j and cyl_y, are available also for real (positive
//  or negative) orders.
...
int zbesy_(double *zr, double *zi, double *fnu, int *kode, int *n, double *cyr, double *cyi, int *nz, double *cwrkr,
           double *cwrki, int *ierr);
int zbesh_(double *zr, double *zi, double *fnu, int *kode, int *m, int *n, double *cyr, double *cyi, int *nz,
           int *ierr);
...
int zs1s2_(double *zrr, double *zri, double *s1r, double *s1i, double *s2r, double *s2i, int *nz, double *ascle,
           double *alim, int *iuf);
int zasyi_(double *zr, double *zi, double *fnu, int *kode, int *n, double *yr, double *yi, int *nz, double *rl,
           double *tol, double *elim, double *alim);
int zacai_(double *zr, double *zi, double *fnu, int *kode, int *mr, int *n, double *yr, double *yi, int *nz, double *rl,
           double *tol, double *elim, double *alim);
int zuni1_(double *zr, double *zi, double *fnu, int *kode, int *n, double *yr, double *yi, int *nz, int *nlast,
           double *fnul, double *tol, double *elim, double *alim);
int zuni2_(double *zr, double *zi, double *fnu, int *kode, int *n, double *yr, double *yi, int *nz, int *nlast,
           double *fnul, double *tol, double *elim, double *alim);
int zbuni_(double *zr, double *zi, double *fnu, int *kode, int *n, double *yr, double *yi, int *nz, int *nui,
...
int zseri_(double *zr, double *zi, double *fnu, int *kode, int *n, double *yr, double *yi, int *nz, double *tol,
           double *elim, double *alim);
int zunik_(double *zrr, double *zri, double *fnu, int *ikflg, int *ipmtr, double *tol, int *init, double *phir,
           double *phii, double *zeta1r, double *zeta1i, double *zeta2r, double *zeta2i, double *sumr, double *sumi,
           double *cwrkr, double *cwrki);
int zunhj_(double *zr, double *zi, double *fnu, int *ipmtr, double *tol, double *phir, double *phii, double *argr,
           double *argi, double *zeta1r, double *zeta1i, double *zeta2r, double *zeta2i, double *asumr, double *asumi,
           double *bsumr, double *bsumi);
int zuchk_(double *yr, double *yi, int *nz, double *ascle, double *tol);
int zuoik_(double *zr, double *zi, double *fnu, int *kode, int *ikflg, int *n, double *yr, double *yi, int *nuf,
           double *tol, double *elim, double *alim);
int zbknu_(double *zr, double *zi, double *fnu, int *kode, int *n, double *yr, double *yi, int *nz, double *tol,
           double *elim, double *alim);
int zrati_(double *zr, double *zi, double *fnu, int *n, double *cyr, double *cyi, double *tol);
int zwrsk_(double *zrr, double *zri, double *fnu, int *kode, int *n, double *yr, double *yi, int *nz, double *cwr,
           double *cwi, double *tol, double *elim, double *alim);
int zbinu_(double *zr, double *zi, double *fnu, int *kode, int *n, double *cyr, double *cyi, int *nz, double *rl,
           double *fnul, double *tol, double *elim, double *alim);
int zshch_(double *zr, double *zi, double *cshr, double *cshi, double *cchr, double *cchi);
int zkscl_(double *zrr, double *zri, double *fnu, int *n, double *yr, double *yi, int *nz, double *rzr, double *rzi,
           double *ascle, double *tol, double *elim);
int zacon_(double *zr, double *zi, double *fnu, int *kode, int *mr, int *n, double *yr, double *yi, int *nz, double *rl,
           double *fnul, double *tol, double *elim, double *alim);
int zbunk_(double *zr, double *zi, double *fnu, int *kode, int *mr, int *n, double *yr, double *yi, int *nz,
           double *tol, double *elim, double *alim);
int zunk1_(double *zr, double *zi, double *fnu, int *kode, int *mr, int *n, double *yr, double *yi, int *nz,
           double *tol, double *elim, double *alim);
int zunk2_(double *zr, double *zi, double *fnu, int *kode, int *mr, int *n, double *yr, double *yi, int *nz,
           double *tol, double *elim, double *alim);
// DEPENDENCY AMOS/SLATEC ROUTINES DECLARATIONS
//-^------------------------------------------------------------------------
...
/* DECK ZS1S2 */
/* Subroutine */
inline int zs1s2_(double *zrr, double *zri, double *s1r, double *s1i, double *s2r, double *s2i, int *nz, double *ascle,
                  double *alim, int *iuf) {
    /* Initialized data */
    double zeror = 0.;
    double zeroi = 0.;
...
/* DECK ZASYI */
/* Subroutine */
inline int zasyi_(double *zr, double *zi, double *fnu, int *kode, int *n, double *yr, double *yi, int *nz, double *rl,
                  double *tol, double *elim, double *alim) {
    /* Initialized data */
    ...
    int inu;
    double raz, czr, ezr, sqk, sti, rzi, tzi, str, rzr, tzr, ak1i, ak1r, cs1i, cs2i, cs1r, cs2r, dnu2, rtr1, dfnu, atol;
    int koded;
...
/* DECK ZACAI */
/* Subroutine */
inline int zacai_(double *zr, double *zi, double *fnu, int *kode, int *mr, int *n, double *yr, double *yi, int *nz,
...
/* DECK ZUNI1 */
/* Subroutine */
inline int zuni1_(double *zr, double *zi, double *fnu, int *kode, int *n, double *yr, double *yi, int *nz, int *nlast,
                  double *fnul, double *tol, double *elim, double *alim) {
    /* Initialized data */
    double zeror = 0.;
    double zeroi = 0.;
    ...
    *nlast = 0;
    ...
    fn = max(*fnu, 1.);
    init = 0;
    zunik_(zr, zi, &fn, &c__1, &c__1, tol, &init, &phir, &phii, &zeta1r, &zeta1i, &zeta2r, &zeta2i, &sumr, &sumi, cwrkr,
           cwrki);
    if (*kode == 1) {
        goto L10;
    }
...
L30:
    ...
    for (i__ = 1; i__ <= i__1; ++i__) {
        fn = *fnu + (nd - i__);
        init = 0;
        zunik_(zr, zi, &fn, &c__1, &c__0, tol, &init, &phir, &phii, &zeta1r, &zeta1i, &zeta2r, &zeta2i, &sumr, &sumi,
               cwrkr, cwrki);
        if (*kode == 1) {
            goto L40;
        }
...
/* DECK ZUNI2 */
/* Subroutine */
inline int zuni2_(double *zr, double *zi, double *fnu, int *kode, int *n, double *yr, double *yi, int *nz, int *nlast,
                  double *fnul, double *tol, double *elim, double *alim) {
    /* Initialized data */
    double zeror = 0.;
    double zeroi = 0.;
...
L10:
    ...
    /* ----------------------------------------------------------------------- */
    fn = max(*fnu, 1.);
    zunhj_(&znr, &zni, &fn, &c__1, tol, &phir, &phii, &argr, &argi, &zeta1r, &zeta1i, &zeta2r, &zeta2i, &asumr, &asumi,
           &bsumr, &bsumi);
    if (*kode == 1) {
        goto L20;
    }
...
L40:
    ...
    for (i__ = 1; i__ <= i__1; ++i__) {
        fn = *fnu + (nd - i__);
        zunhj_(&znr, &zni, &fn, &c__0, tol, &phir, &phii, &argr, &argi, &zeta1r, &zeta1i, &zeta2r, &zeta2i, &asumr,
               &asumi, &bsumr, &bsumi);
        if (*kode == 1) {
            goto L50;
        }
...
/* DECK ZBUNI */
/* Subroutine */
inline int zbuni_(double *zr, double *zi, double *fnu, int *kode, int *n, double *yr, double *yi, int *nz, int *nui,
                  int *nlast, double *fnul, double *tol, double *elim, double *alim) {
    /* System generated locals */
    int i__1;
...
/* DECK ZMLRI */
/* Subroutine */
inline int zmlri_(double *zr, double *zi, double *fnu, int *kode, int *n, double *yr, double *yi, int *nz,
                  double *tol) {
    /* Initialized data */
    double zeror = 0.;
    double zeroi = 0.;
...
inline double dgamln_(double *z__, int *ierr) {
    ...
    double gln[100] = {0.,
                       ...
                       354.539085519440809,
                       359.134205369575399};
    double cf[22] = {.0833333333333333333,   -.00277777777777777778, 7.93650793650793651e-4, -5.95238095238095238e-4,
                     8.41750841750841751e-4, -.00191752691752691753, .00641025641025641026,  -.0295506535947712418,
                     .179644372368830573,    -1.39243221690590112,   13.402864044168392,     -156.848284626002017,
                     2193.10333333333333,    -36108.7712537249894,   691472.268851313067,    -15238221.5394074162,
                     382900751.391414141,    -10882266035.7843911,   347320283765.002252,    -12369602142269.2745,
                     488788064793079.335,    -21320333960919373.9};
...
/* DECK ZSERI */
/* Subroutine */
inline int zseri_(double *zr, double *zi, double *fnu, int *kode, int *n, double *yr, double *yi, int *nz, double *tol,
                  double *elim, double *alim) {
    /* Initialized data */
    double zeror = 0.;
    double zeroi = 0.;
    ...
    double wi[2], rs, ss;
    int nw;
    double wr[2], s1i, s2i, s1r, s2r, cki, acz, arm, ckr, czi, hzi, raz, czr, sti, hzr, rzi, str, rzr, ak1i, ak1r, rtr1,
        dfnu;
    int idum;
    double atol;
    double fnup;
...
/* DECK ZUNIK */
/* Subroutine */
inline int zunik_(double *zrr, double *zri, double *fnu, int *ikflg, int *ipmtr, double *tol, int *init, double *phir,
                  double *phii, double *zeta1r, double *zeta1i, double *zeta2r, double *zeta2i, double *sumr,
...
/* DECK ZUNHJ */
/* Subroutine */
inline int zunhj_(double *zr, double *zi, double *fnu, int *ipmtr, double *tol, double *phir, double *phii,
    ...
    double c__[105] = {1.,
                       ...
                       18257.7554742931747};
    double alfa[180] = {
        -.00444444444444444444,  -9.22077922077922078e-4, -8.84892884892884893e-5, 1.65927687832449737e-4,
        2.4669137274179291e-4,   2.6599558934625478e-4,   2.61824297061500945e-4,  2.48730437344655609e-4,
        2.32721040083232098e-4,  2.16362485712365082e-4,  2.00738858762752355e-4,  1.86267636637545172e-4,
        1.73060775917876493e-4,  1.61091705929015752e-4,  1.50274774160908134e-4,  1.40503497391269794e-4,
        1.31668816545922806e-4,  1.23667445598253261e-4,  1.16405271474737902e-4,  1.09798298372713369e-4,
        1.03772410422992823e-4,  9.82626078369363448e-5,  9.32120517249503256e-5,  8.85710852478711718e-5,
        8.42963105715700223e-5,  8.03497548407791151e-5,  7.66981345359207388e-5,  7.33122157481777809e-5,
        7.01662625163141333e-5,  6.72375633790160292e-5,  6.93735541354588974e-4,  2.32241745182921654e-4,
        -1.41986273556691197e-5, -1.1644493167204864e-4,  -1.50803558053048762e-4, -1.55121924918096223e-4,
        -1.46809756646465549e-4, -1.33815503867491367e-4, -1.19744975684254051e-4, -1.0618431920797402e-4,
        -9.37699549891194492e-5, -8.26923045588193274e-5, -7.29374348155221211e-5, -6.44042357721016283e-5,
        -5.69611566009369048e-5, -5.04731044303561628e-5, -4.48134868008882786e-5, -3.98688727717598864e-5,
        -3.55400532972042498e-5, -3.1741425660902248e-5,  -2.83996793904174811e-5, -2.54522720634870566e-5,
        -2.28459297164724555e-5, -2.05352753106480604e-5, -1.84816217627666085e-5, -1.66519330021393806e-5,
        -1.50179412980119482e-5, -1.35554031379040526e-5, -1.22434746473858131e-5, -1.10641884811308169e-5,
        -3.54211971457743841e-4, -1.56161263945159416e-4, 3.0446550359493641e-5,   1.30198655773242693e-4,
        1.67471106699712269e-4,  1.70222587683592569e-4,  1.56501427608594704e-4,  1.3633917097744512e-4,
        1.14886692029825128e-4,  9.45869093034688111e-5,  7.64498419250898258e-5,  6.07570334965197354e-5,
        4.74394299290508799e-5,  3.62757512005344297e-5,  2.69939714979224901e-5,  1.93210938247939253e-5,
        1.30056674793963203e-5,  7.82620866744496661e-6,  3.59257485819351583e-6,  1.44040049814251817e-7,
        -2.65396769697939116e-6, -4.9134686709848591e-6,  -6.72739296091248287e-6, -8.17269379678657923e-6,
        -9.31304715093561232e-6, -1.02011418798016441e-5, -1.0880596251059288e-5,  -1.13875481509603555e-5,
        -1.17519675674556414e-5, -1.19987364870944141e-5, 3.78194199201772914e-4,  2.02471952761816167e-4,
        -6.37938506318862408e-5, -2.38598230603005903e-4, -3.10916256027361568e-4, -3.13680115247576316e-4,
        -2.78950273791323387e-4, -2.28564082619141374e-4, -1.75245280340846749e-4, -1.25544063060690348e-4,
        -8.22982872820208365e-5, -4.62860730588116458e-5, -1.72334302366962267e-5, 5.60690482304602267e-6,
        2.313954431482868e-5,    3.62642745856793957e-5,  4.58006124490188752e-5,  5.2459529495911405e-5,
        5.68396208545815266e-5,  5.94349820393104052e-5,  6.06478527578421742e-5,  6.08023907788436497e-5,
        6.01577894539460388e-5,  5.891996573446985e-5,    5.72515823777593053e-5,  5.52804375585852577e-5,
        5.3106377380288017e-5,   5.08069302012325706e-5,  4.84418647620094842e-5,  4.6056858160747537e-5,
        -6.91141397288294174e-4, -4.29976633058871912e-4, 1.83067735980039018e-4,  6.60088147542014144e-4,
        8.75964969951185931e-4,  8.77335235958235514e-4,  7.49369585378990637e-4,  5.63832329756980918e-4,
        3.68059319971443156e-4,  1.88464535514455599e-4,  3.70663057664904149e-5,  -8.28520220232137023e-5,
        -1.72751952869172998e-4, -2.36314873605872983e-4, -2.77966150694906658e-4, -3.02079514155456919e-4,
        -3.12594712643820127e-4, -3.12872558758067163e-4, -3.05678038466324377e-4, -2.93226470614557331e-4,
        -2.77255655582934777e-4, -2.59103928467031709e-4, -2.39784014396480342e-4, -2.20048260045422848e-4,
        -2.00443911094971498e-4, -1.81358692210970687e-4, -1.63057674478657464e-4, -1.45712672175205844e-4,
        ...
        3.24724948503090564e-4,  2.20342042730246599e-4,  1.28412898401353882e-4,  4.82005924552095464e-5};
    double beta[210] = {
        .0179988721413553309,    .00559964911064388073,   .00288501402231132779,   .00180096606761053941,
        .00124753110589199202,   9.22878876572938311e-4,  7.14430421727287357e-4,  5.71787281789704872e-4,
        4.69431007606481533e-4,  3.93232835462916638e-4,  3.34818889318297664e-4,  2.88952148495751517e-4,
        2.52211615549573284e-4,  2.22280580798883327e-4,  1.97541838033062524e-4,  1.76836855019718004e-4,
        1.59316899661821081e-4,  1.44347930197333986e-4,  1.31448068119965379e-4,  1.20245444949302884e-4,
        1.10449144504599392e-4,  1.01828770740567258e-4,  9.41998224204237509e-5,  8.74130545753834437e-5,
        8.13466262162801467e-5,  7.59002269646219339e-5,  7.09906300634153481e-5,  6.65482874842468183e-5,
        6.25146958969275078e-5,  5.88403394426251749e-5,  -.00149282953213429172,  -8.78204709546389328e-4,
        -5.02916549572034614e-4, -2.94822138512746025e-4, -1.75463996970782828e-4, -1.04008550460816434e-4,
        -5.96141953046457895e-5, -3.1203892907609834e-5,  -1.26089735980230047e-5, -2.42892608575730389e-7,
        ...
        6.93271105657043598e-5,  1.76258683069991397e-5,  -1.35744996343269136e-5, -3.17972413350427135e-5,
        -4.18861861696693365e-5, -4.69004889379141029e-5, -4.87665447413787352e-5, -4.87010031186735069e-5,
        -4.74755620890086638e-5, -4.55813058138628452e-5, -4.33309644511266036e-5, -4.09230193157750364e-5,
        -3.84822638603221274e-5, -3.60857167535410501e-5, -3.37793306123367417e-5, -3.15888560772109621e-5,
        -2.95269561750807315e-5, -2.75978914828335759e-5, -2.58006174666883713e-5, -2.413083567612802e-5,
        -2.25823509518346033e-5, -2.11479656768912971e-5, -1.98200638885294927e-5, -1.85909870801065077e-5,
        -1.74532699844210224e-5, -1.63997823854497997e-5, -4.74617796559959808e-4, -4.77864567147321487e-4,
        -3.20390228067037603e-4, -1.61105016119962282e-4, -4.25778101285435204e-5, 3.44571294294967503e-5,
        7.97092684075674924e-5,  1.031382367082722e-4,    1.12466775262204158e-4,  1.13103642108481389e-4,
        1.08651634848774268e-4,  1.01437951597661973e-4,  9.29298396593363896e-5,  8.40293133016089978e-5,
        7.52727991349134062e-5,  6.69632521975730872e-5,  5.92564547323194704e-5,  5.22169308826975567e-5,
        4.58539485165360646e-5,  4.01445513891486808e-5,  3.50481730031328081e-5,  3.05157995034346659e-5,
        2.64956119950516039e-5,  2.29363633690998152e-5,  1.97893056664021636e-5,  1.70091984636412623e-5,
        1.45547428261524004e-5,  1.23886640995878413e-5,  1.04775876076583236e-5,  8.79179954978479373e-6,
        7.36465810572578444e-4,  8.72790805146193976e-4,  6.22614862573135066e-4,  2.85998154194304147e-4,
        3.84737672879366102e-6,  -1.87906003636971558e-4, -2.97603646594554535e-4, -3.45998126832656348e-4,
        -3.53382470916037712e-4, -3.35715635775048757e-4, -3.04321124789039809e-4, -2.66722723047612821e-4,
        -2.27654214122819527e-4, -1.89922611854562356e-4, -1.5505891859909387e-4,  -1.2377824076187363e-4,
        -9.62926147717644187e-5, -7.25178327714425337e-5, -5.22070028895633801e-5, -3.50347750511900522e-5,
        -2.06489761035551757e-5, -8.70106096849767054e-6, 1.1369868667510029e-6,   9.16426474122778849e-6,
        1.5647778542887262e-5,   2.08223629482466847e-5,  2.48923381004595156e-5,  2.80340509574146325e-5,
        3.03987774629861915e-5,  3.21156731406700616e-5,  -.00180182191963885708,  -.00243402962938042533,
        -.00183422663549856802,  -7.62204596354009765e-4, 2.39079475256927218e-4,  9.49266117176881141e-4,
        .00134467449701540359,   .00148457495259449178,   .00144732339830617591,   .00130268261285657186,
        .00110351597375642682,   8.86047440419791759e-4,  6.73073208165665473e-4,  4.77603872856582378e-4,
        3.05991926358789362e-4,  1.6031569459472163e-4,   4.00749555270613286e-5,  -5.66607461635251611e-5,
        -1.32506186772982638e-4, -1.90296187989614057e-4, -2.32811450376937408e-4, -2.62628811464668841e-4,
        -2.82050469867598672e-4, -2.93081563192861167e-4, -2.97435962176316616e-4, -2.96557334239348078e-4,
        -2.91647363312090861e-4, -2.83696203837734166e-4, -2.73512317095673346e-4, -2.6175015580676858e-4,
        .00638585891212050914,   .00962374215806377941,   .00761878061207001043,   .00283219055545628054,
        -.0020984135201272009,   -.00573826764216626498,  -.0077080424449541462,   -.00821011692264844401,
        -.00765824520346905413,  -.00647209729391045177,  -.00499132412004966473,  -.0034561228971313328,
        -.00201785580014170775,  -7.59430686781961401e-4, 2.84173631523859138e-4,  .00110891667586337403,
        .00172901493872728771,   .00216812590802684701,   .00245357710494539735,   .00261281821058334862,
        .00267141039656276912,   .0026520307339598043,    .00257411652877287315,   .00245389126236094427,
        .00230460058071795494,   .00213684837686712662,   .00195896528478870911,   .00177737008679454412,
        .00159690280765839059,   .00142111975664438546};
    double gama[30] = {
        .629960524947436582,  .251984209978974633,  .154790300415655846,  .110713062416159013,  .0857309395527394825,
        .0697161316958684292, .0586085671893713576, .0504698873536310685, .0442600580689154809, .0393720661543509966,
        .0354283195924455368, .0321818857502098231, .0294646240791157679, .0271581677112934479, .0251768272973861779,
        .0234570755306078891, .0219508390134907203, .020621082823564624,  .0194388240897880846, .0183810633800683158,
        .0174293213231963172, .0165685837786612353, .0157865285987918445, .0150729501494095594, .0144193250839954639,
        .0138184805735341786, .0132643378994276568, .0127517121970498651, .0122761545318762767, .0118338262398482403};
...
/* DECK ZUOIK */
/* Subroutine */
inline int zuoik_(double *zr, double *zi, double *fnu, int *kode, int *ikflg, int *n, double *yr, double *yi, int *nuf,
                  double *tol, double *elim, double *alim) {
    /* Initialized data */
    double zeror = 0.;
    double zeroi = 0.;
...
L20:
    ...
    init = 0;
    zunik_(&zrr, &zri, &gnu, ikflg, &c__1, tol, &init, &phir, &phii, &zeta1r, &zeta1i, &zeta2r, &zeta2i, &sumr, &sumi,
           cwrkr, cwrki);
    czr = -zeta1r + zeta2r;
    czi = -zeta1i + zeta2i;
    goto L50;
L30:
    ...
    znr = -znr;
L40:
    zunhj_(&znr, &zni, &gnu, &c__1, tol, &phir, &phii, &argr, &argi, &zeta1r, &zeta1i, &zeta2r, &zeta2i, &asumr, &asumi,
           &bsumr, &bsumi);
    czr = -zeta1r + zeta2r;
    czi = -zeta1i + zeta2i;
    aarg = zabs_(&argr, &argi);
...
/* DECK ZBKNU */
/* Subroutine */
inline int zbknu_(double *zr, double *zi, double *fnu, int *kode, int *n, double *yr, double *yi, int *nz, double *tol,
                  double *elim, double *alim) {
    /* Initialized data */
    int kmax = 30;
    ...
    double cc[8] = {.577215664901532861,     -.0420026350340952355,   -.0421977345555443367,  .00721894324666309954,
                    -2.15241674114950973e-4, -2.01348547807882387e-5, 1.13302723198169588e-6, 6.11609510448141582e-9};
    double czeror = 0.;
    double czeroi = 0.;
    double coner = 1.;
    double conei = 0.;
    ...
    int nw;
    double p1i, p2i, s1i, s2i, p2m, p1r, p2r, s1r, s2r, cbi, cbr, cki, caz, csi, ckr, fhs, fks, rak, czi, dnu, csr, elm,
        zdi, bry[3], pti, czr, sti, zdr, cyr[2], rzi, ptr, cyi[2];
    int inu;
...
/* DECK ZWRSK */
/* Subroutine */
inline int zwrsk_(double *zrr, double *zri, double *fnu, int *kode, int *n, double *yr, double *yi, int *nz,
...
/* DECK ZBINU */
/* Subroutine */
inline int zbinu_(double *zr, double *zi, double *fnu, int *kode, int *n, double *cyr, double *cyi, int *nz, double *rl,
                  double *fnul, double *tol, double *elim, double *alim) {
    /* Initialized data */
    double zeror = 0.;
    double zeroi = 0.;
...
/* DECK ZKSCL */
/* Subroutine */
inline int zkscl_(double *zrr, double *zri, double *fnu, int *n, double *yr, double *yi, int *nz, double *rzr,
...
/* DECK ZACON */
/* Subroutine */
inline int zacon_(double *zr, double *zi, double *fnu, int *kode, int *mr, int *n, double *yr, double *yi, int *nz,
...
/* DECK ZBUNK */
/* Subroutine */
inline int zbunk_(double *zr, double *zi, double *fnu, int *kode, int *mr, int *n, double *yr, double *yi, int *nz,
                  double *tol, double *elim, double *alim) {
    double ax, ay;
...
/* DECK ZUNK1 */
/* Subroutine */
inline int zunk1_(double *zr, double *zi, double *fnu, int *kode, int *mr, int *n, double *yr, double *yi, int *nz,
                  double *tol, double *elim, double *alim) {
    /* Initialized data */
    double zeror = 0.;
    double zeroi = 0.;
...
L10:
    ...
    for (i__ = 1; i__ <= i__1; ++i__) {
        ...
        fn = *fnu + (i__ - 1);
        init[j - 1] = 0;
        zunik_(&zrr, &zri, &fn, &c__2, &c__0, tol, &init[j - 1], &phir[j - 1], &phii[j - 1], &zeta1r[j - 1],
               &zeta1i[j - 1], &zeta2r[j - 1], &zeta2i[j - 1], &sumr[j - 1], &sumi[j - 1], &cwrkr[(j << 4) - 16],
               &cwrki[(j << 4) - 16]);
        if (*kode == 1) {
            goto L20;
        }
...
L75:
    ...
    initd = 0;
    zunik_(&zrr, &zri, &fn, &c__2, &ipard, tol, &initd, &phidr, &phidi, &zet1dr, &zet1di, &zet2dr, &zet2di, &sumdr,
...
L170:
    ...
    L175:
        ...
        initd = 0;
    L180:
        zunik_(&zrr, &zri, &fn, &c__1, &c__0, tol, &initd, &phidr, &phidi, &zet1dr, &zet1di, &zet2dr, &zet2di, &sumdr,
...
/* DECK ZUNK2 */
/* Subroutine */
inline int zunk2_(double *zr, double *zi, double *fnu, int *kode, int *mr, int *n, double *yr, double *yi, int *nz,
                  double *tol, double *elim, double *alim) {
    /* Initialized data */
    double zeror = 0.;
...
L20:
    ...
    for (i__ = 1; i__ <= i__1; ++i__) {
        ...
        j = 3 - j;
        fn = *fnu + (i__ - 1);
        zunhj_(&znr, &zni, &fn, &c__0, tol, &phir[j - 1], &phii[j - 1], &argr[j - 1], &argi[j - 1], &zeta1r[j - 1],
               &zeta1i[j - 1], &zeta2r[j - 1], &zeta2i[j - 1], &asumr[j - 1], &asumi[j - 1], &bsumr[j - 1],
               &bsumi[j - 1]);
        if (*kode == 1) {
            goto L30;
        }
...
L85:
    ...
    zunhj_(&znr, &zni, &fn, &ipard, tol, &phidr, &phidi, &argdr, &argdi, &zet1dr, &zet1di, &zet2dr, &zet2di, &asumdr,
...
L190:
    ...
    L175:
        ...
        zunhj_(&znr, &zni, &fn, &c__0, tol, &phidr, &phidi, &argdr, &argdi, &zet1dr, &zet1di, &zet2dr, &zet2di, &asumdr,
               &asumdi, &bsumdr, &bsumdi);
    L210:
        if (*kode == 1) {
            goto L220;
...
/* DECK ZBESJ */
/* Subroutine */
inline int zbesj_(double *zr, double *zi, double *fnu, int *kode, int *n, double *cyr, double *cyi, int *nz,
                  int *ierr) {
    /* Initialized data */
    double hpi = 1.57079632679489662;
...
/* DECK ZBESY */
/* Subroutine */
inline int zbesy_(double *zr, double *zi, double *fnu, int *kode, int *n, double *cyr, double *cyi, int *nz,
...
/* DECK ZBESH */
/* Subroutine */
inline int zbesh_(double *zr, double *zi, double *fnu, int *kode, int *m, int *n, double *cyr, double *cyi, int *nz,
                  int *ierr) {
    /* Initialized data */
    double hpi = 1.57079632679489662;
...
/* DECK ZBESI */
/* Subroutine */
inline int zbesi_(double *zr, double *zi, double *fnu, int *kode, int *n, double *cyr, double *cyi, int *nz,
                  int *ierr) {
    /* Initialized data */
    double pi = 3.14159265358979324;
    double coner = 1.;
...
/* DECK ZBESK */
/* Subroutine */
inline int zbesk_(double *zr, double *zi, double *fnu, int *kode, int *n, double *cyr, double *cyi, int *nz,
                  int *ierr) {
    /* System generated locals */
    int i__1, i__2;
    double d__1;
...
inline int zairy_(double *zr, double *zi, int *id, int *kode, double *air, double *aii, int *nz, int *ierr) {
    ...
    double rl;
    int mr;
    double s1i, az3, s2i, s1r, s2r, z3i, z3r, dig, fid, cyi[1], r1m5, fnu, cyr[1], tol, sti, ptr, str, sfac, alim, elim,
        alaz, csqi;
...
inline int zbiry_(double *zr, double *zi, int *id, int *kode, double *bir, double *bii, int *ierr) {
    ...
    int nz;
    double s1i, az3, s2i, s1r, s2r, z3i, z3r, eaa, fid, dig, cyi[2], fmr, r1m5, fnu, cyr[2], tol, sti, str, sfac, alim,
        elim, csqi;
...
inline void _flag_zbesj_(const int _ierr, const int _nz) {
    ...
    case 2:
        std::cerr
            << "[bessel::slatec::zbesj_] Flag -> Overflow: No computation, imag(_z) too large on nonscaled calculation."
            << std::endl;
        break;
    case 3:
        std::cerr << "[bessel::slatec::zbesj_] Flag -> The abs(_z) or abs(_nu)+_n-1 large: Computation done but losses "
                     "of signifcance by argument reduction produce less than half of machine accuracy."
                  << std::endl;
        break;
    case 4:
        std::cerr << "[bessel::slatec::zbesj_] Flag -> The abs(_z) or abs(_nu)+_n-1 too large: No computation because "
                     "of complete losses of significance by argument reduction."
                  << std::endl;
        break;
    case 5:
        std::cerr << "[bessel::slatec::zbesj_] Flag -> Error: No computation, algorithm termination condition not met."
                  << std::endl;
        break;
    }
    if (_nz != 0)
        std::cerr << "[bessel::slatec::zbesj_] Flag -> Number of components set to zero due to underflow: " << _nz
                  << "." << std::endl;
}
inline void _flag_zbesy_(const int _ierr, const int _nz) {
    ...
    case 1:
        ...
        break;
    case 2:
        std::cerr << "[bessel::slatec::zbesy_] Flag -> Overflow: No computation, abs(_nu) too large or abs(_z) is too "
                     "small or both."
                  << std::endl;
        break;
    case 3:
        std::cerr << "[bessel::slatec::zbesy_] Flag -> The abs(_z) or abs(_nu)+_n-1 large: Computation done but losses "
                     "of signifcance by argument reduction produce less than half of machine accuracy."
                  << std::endl;
        break;
    case 4:
        std::cerr << "[bessel::slatec::zbesy_] Flag -> The abs(_z) or abs(_nu)+_n-1 too large: No computation because "
                     "of complete losses of significance by argument reduction."
                  << std::endl;
        break;
    case 5:
        std::cerr << "[bessel::slatec::zbesy_] Flag -> Error: No computation, algorithm termination condition not met."
                  << std::endl;
        break;
    }
    if (_nz != 0)
        std::cerr << "[bessel::slatec::zbesy_] Flag -> Number of components set to zero due to underflow: " << _nz
                  << "." << std::endl;
}
inline void _flag_zbesh_(const int _ierr, const int _nz) {
    ...
    case 1:
        ...
        break;
    case 2:
        std::cerr << "[bessel::slatec::zbesh_] Flag -> Overflow: No computation, abs(_nu) too large or abs(_z) too "
                     "small or both."
                  << std::endl;
        break;
    case 3:
        std::cerr << "[bessel::slatec::zbesh_] Flag -> The abs(_z) or abs(_nu)+_n-1 large: Computation done but losses "
                     "of signifcance by argument reduction produce less than half of machine accuracy."
                  << std::endl;
        break;
    case 4:
        std::cerr << "[bessel::slatec::zbesh_] Flag -> The abs(_z) or abs(_nu)+_n-1 too large: No computation because "
                     "of complete losses of significance by argument reduction."
                  << std::endl;
        break;
    case 5:
        std::cerr << "[bessel::slatec::zbesh_] Flag -> Error: No computation, algorithm termination condition not met."
                  << std::endl;
        break;
    }
    if (_nz != 0)
        std::cerr << "[bessel::slatec::zbesh_] Flag -> Number of components set to zero due to underflow: " << _nz
                  << "." << std::endl;
}
inline void _flag_zbesi_(const int _ierr, const int _nz) {
    ...
    case 2:
        std::cerr
            << "[bessel::slatec::zbesi_] Flag -> Overflow: No computation, real(_z) too large on nonscaled calculation."
            << std::endl;
        break;
    case 3:
        std::cerr << "[bessel::slatec::zbesi_] Flag -> The abs(_z) or abs(_nu)+_n-1 large: Computation done but losses "
                     "of signifcance by argument reduction produce less than half of machine accuracy."
                  << std::endl;
        break;
    case 4:
        std::cerr << "[bessel::slatec::zbesi_] Flag -> The abs(z) or abs(_nu)+_n-1 too large: No computation because "
                     "of complete losses of significance by argument reduction."
                  << std::endl;
        break;
    case 5:
        std::cerr << "[bessel::slatec::zbesi_] Flag -> Error: No computation, algorithm termination condition not met."
                  << std::endl;
        break;
    }
    if (_nz != 0)
        std::cerr << "[bessel::slatec::zbesi_] Flag -> Number of components set to zero due to underflow: " << _nz
                  << "." << std::endl;
}
inline void _flag_zbesk_(const int _ierr, const int _nz) {
    ...
    case 1:
        ...
        break;
    case 2:
        std::cerr << "[bessel::slatec::zbesk_] Flag -> Overflow: No computation, abs(_nu) is too large or abs(_z) is "
                     "too small or both."
                  << std::endl;
        break;
    case 3:
        std::cerr << "[bessel::slatec::zbesk_] Flag -> The abs(_z) or abs(_nu)+_n-1 large: Computation done but losses "
                     "of signifcance by argument reduction produce less than half of machine accuracy."
                  << std::endl;
        break;
    case 4:
        std::cerr << "[bessel::slatec::zbesk_] Flag -> The abs(_z) or abs(_nu)+_n-1 too large: No computation because "
                     "of complete losses of significance by argument reduction."
                  << std::endl;
        break;
    case 5:
        std::cerr << "[bessel::slatec::zbesk_] Flag -> Error: No computation, algorithm termination condition not met."
                  << std::endl;
        break;
    }
    if (_nz != 0)
        std::cerr << "[bessel::slatec::zbesk_] Flag -> Number of components set to zero due to underflow: " << _nz
                  << "." << std::endl;
}
inline void _flag_zairy_(const int _ierr, const int _nz) {
    ...
    case 1:
        ...
        break;
    case 2:
        std::cerr << "[bessel::slatec::zairy_] Flag -> Overflow: No computation, real((2/3)*_z*sqrt(_z)) is too large "
                     "on nonscaled calculation."
                  << std::endl;
        break;
    case 3:
        std::cerr << "[bessel::slatec::zairy_] Flag -> The abs(_z) large: Computation completed, losses of signifcance "
                     "by argument reduction produce less than half of machine accuracy."
                  << std::endl;
        break;
    case 4:
        std::cerr << "[bessel::slatec::zairy_] Flag -> The abs(_z) too large: No computation, complete loss of "
                     "accuracy by argument reduction."
                  << std::endl;
        break;
    case 5:
        std::cerr << "[bessel::slatec::zairy_] Flag -> Error: No computation, algorithm termination condition not met."
                  << std::endl;
        break;
    }
    if (_nz != 0)
        std::cerr << "[bessel::slatec::zairy_] Flag -> Result set to zero due to underflow in -pi/3 < arg(_z) < pi/3."
                  << std::endl;
}
inline void _flag_zbiry_(const int _ierr) {
    ...
    case 1:
        ...
        break;
    case 2:
        std::cerr << "[bessel::slatec::zbiry_] Flag -> Overflow: No computation, real(_z) is too large on nonscaled "
                     "calculation."
                  << std::endl;
        break;
    case 3:
        std::cerr << "[bessel::slatec::zbiry_] Flag -> The abs(_z) large: Computation completed, losses of signifcance "
                     "by argument reduction produce less than half of machine accuracy."
                  << std::endl;
        break;
    case 4:
        std::cerr << "[bessel::slatec::zbiry_] Flag -> The abs(_z) too large: No computation, complete loss of "
                     "accuracy by argument reduction."
                  << std::endl;
        break;
    case 5:
        std::cerr << "[bessel::slatec::zbiry_] Flag -> Error: No computation, algorithm termination condition not met."
                  << std::endl;
        break;
    }
}
...
template <typename T1, typename T2>
inline void cyl_j(const T1 _nu, const int _n, const std::complex<T2> _z, std::complex<T2> *_cyl_j, bool _scaled = false,
                  bool _flags = false) {
    // Parameters
    ...
    //  _scaled: if true, returns an array of size _n with the scaled version J_nu(z)*exp(-|Im(z)|) for the orders _nu,
    //  _nu+1, ..., _nu+_n. _flags:  if true, print error messages.
    ...
    if (n <= 0) {
        if (_flags)
            std::cerr << "[bessel::cyl_j] Flag -> Input error: No computation, _n must be an integer greater than zero."
                      << std::endl;
    } else if (nu >= 0.) {
        ...
        if (double(floor(fnu)) == fnu) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                _cyl_j[i] = (std::complex<T2>(cjr[tmp1], cji[tmp1])) * cos(tmp2) -
                            (std::complex<T2>(cyr[tmp1], cyi[tmp1])) * sin(tmp2);
            }
        }
    } else {
        ...
        if (double(floor(fnu)) == fnu) {
            ...
            for (int i = 0; i < n_m; i++) {
                ...
                int tmp1 = n_m - 1 - i;
                double tmp2 = (fnu_m + double(tmp1)) * M_PI;
                _cyl_j[i] = (std::complex<T2>(cjr_m[tmp1], cji_m[tmp1])) * cos(tmp2) -
                            (std::complex<T2>(cyr_m[tmp1], cyi_m[tmp1])) * sin(tmp2);
            }
        }
...
template <typename T1, typename T2>
inline void cyl_y(const T1 _nu, const int _n, const std::complex<T2> _z, std::complex<T2> *_cyl_y, bool _scaled = false,
                  bool _flags = false) {
    // Parameters
    //  _nu:     real first order to be calculated.
    //  _n:      int to return an array with the orders _nu, _nu+1, ..., _nu+_n.
    ...
    //  _scaled: if true, returns an array of size _n with the scaled version Y_nu(z)*exp(-|Im(z)|) for the orders _nu,
    //  _nu+1, ..., _nu+_n. _flags:  if true, print error messages.
    ...
    if (n <= 0) {
        if (_flags)
            std::cerr << "[bessel::cyl_y] Flag -> Input error: No computation, _n must be an integer greater than zero."
                      << std::endl;
    } else if (abs(z) == 0.) {
        double dinf = std::numeric_limits<double>::infinity();
        for (int i = 0; i < n; i++) {
        ...
        if (double(floor(fnu)) == fnu) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                int tmp1 = n - 1 - i;
                double tmp2 = (fnu_m + double(tmp1)) * M_PI;
                _cyl_y[i] = (std::complex<T2>(cjr[tmp1], cji[tmp1])) * sin(tmp2) +
                            (std::complex<T2>(cyr[tmp1], cyi[tmp1])) * cos(tmp2);
            }
        }
    } else {
        ...
        if (double(floor(fnu)) == fnu) {
            ...
            for (int i = 0; i < n_m; i++) {
                ...
                int tmp1 = n_m - 1 - i;
                double tmp2 = (fnu_m + double(tmp1)) * M_PI;
                _cyl_y[i] = (std::complex<T2>(cjr_m[tmp1], cji_m[tmp1])) * sin(tmp2) +
                            (std::complex<T2>(cyr_m[tmp1], cyi_m[tmp1])) * cos(tmp2);
            }
        }
...
template <typename T1, typename T2>
inline void cyl_h1(const T1 _nu, const int _n, const std::complex<T2> _z, std::complex<T2> *_cyl_h1,
                   bool _scaled = false, bool _flags = false) {
    // Parameters
    //  _nu:     real first order to be calculated.
    //  _n:      int to return an array with the orders _nu, _nu+1, ..., _nu+_n.
    //  _z:      complex argument.
    //  _cyl_h1: array of size _n to output H1_nu(z) for the orders _nu, _nu+1, ..., _nu+_n.
    //  _scaled: if true, returns an array of size _n with the scaled version H1_nu(z)*exp(-iz). for the orders _nu,
    //  _nu+1, ..., _nu+_n. _flags:  if true, print error messages.
    ...
    if (n <= 0) {
        if (_flags)
            std::cerr
                << "[bessel::cyl_h1] Flag -> Input error: No computation, _n must be an integer greater than zero."
                << std::endl;
    } else if (abs(z) == 0.) {
        // Complex infinity for all orders
        double dinf = std::numeric_limits<double>::infinity();
...
template <typename T1, typename T2>
inline void cyl_h2(const T1 _nu, const int _n, const std::complex<T2> _z, std::complex<T2> *_cyl_h2,
                   bool _scaled = false, bool _flags = false) {
    // Parameters
    //  _nu:     real first order to be calculated.
    //  _n:      int to return an array with the orders _nu, _nu+1, ..., _nu+_n.
    ...
    //  _scaled: if true, returns an array of size _n with the scaled version H2_nu(z)*exp(+iz). for the orders _nu,
    //  _nu+1, ..., _nu+_n. _flags:  if true, print error messages.
    ...
    if (n <= 0) {
        if (_flags)
            std::cerr
                << "[bessel::cyl_h2] Flag -> Input error: No computation, _n must be an integer greater than zero."
                << std::endl;
    } else if (abs(z) == 0.) {
        // Complex infinity for all orders
        double dinf = std::numeric_limits<double>::infinity();
...
template <typename T1, typename T2>
inline void cyl_i(const T1 _nu, const int _n, const std::complex<T2> _z, std::complex<T2> *_cyl_i, bool _scaled = false,
                  bool _flags = false) {
    // Parameters
    //  _nu:     real first order to be calculated.
    //  _n:      int to return an array with the orders _nu, _nu+1, ..., _nu+_n.
    ...
    //  _scaled: if true, returns an array of size _n with the scaled version I_nu(z)*exp(-|Re(z)|) for the orders _nu,
    //  _nu+1, ..., _nu+_n. _flags:  if true, print error messages.
    ...
    if (n <= 0) {
        if (_flags)
            std::cerr << "[bessel::cyl_i] Flag -> Input error: No computation, _n must be an integer greater than zero."
                      << std::endl;
    } else if (nu >= 0.) {
        // Array of only positive orders, including the order 0
        ...
        if (double(floor(fnu)) == fnu) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                int tmp1 = n - 1 - i;
                double tmp2 = (fnu_m + double(tmp1)) * M_PI;
                _cyl_i[i] = (std::complex<T2>(cir[tmp1], cii[tmp1])) +
                            (std::complex<T2>(ckr[tmp1], cki[tmp1])) * sin(tmp2) * M_2_PI;
            }
        }
    } else {
        // Array of negative and positive orders
        ...
        if (double(floor(fnu)) == fnu) {
            ...
            for (int i = 0; i < n_m; i++) {
                ...
                int tmp1 = n_m - 1 - i;
                double tmp2 = (fnu_m + double(tmp1)) * M_PI;
                _cyl_i[i] = (std::complex<T2>(cir_m[tmp1], cii_m[tmp1])) +
                            (std::complex<T2>(ckr_m[tmp1], cki_m[tmp1])) * sin(tmp2) * M_2_PI;
            }
        }
...
template <typename T1, typename T2>
inline void cyl_k(const T1 _nu, const int _n, const std::complex<T2> _z, std::complex<T2> *_cyl_k, bool _scaled = false,
                  bool _flags = false) {
    // Parameters
    //  _nu:     real first order to be calculated.
    //  _n:      int to return an array with the orders _nu, _nu+1, ..., _nu+_n.
    ...
    //  _scaled: if true, returns an array of size _n with the scaled version K_nu(z)*exp(z) for the orders _nu, _nu+1,
    //  ..., _nu+_n. _flags:  if true, print error messages.
    ...
    if (n <= 0) {
        if (_flags)
            std::cerr << "[bessel::cyl_k] Flag -> Input error: No computation, _n must be an integer greater than zero."
                      << std::endl;
    } else if (abs(z) == 0.) {
        double dinf = std::numeric_limits<double>::infinity();
        for (int i = 0; i < n; i++) {
