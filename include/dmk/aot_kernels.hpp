...
// ESP Laplace-dipole (baked at fixed sigma=1.35 from get_esp_correction_coeffs). Generated by
// generate_aot_kernels into aot_kernels.cpp -- regenerate after adding the esp_baked entry.
template <class Real, int MaxVecLen>
...
// ESP Stokeslet/Stresslet: scale-invariant biharmonic residual, baked like the scalars (no runtime
// coeffs/gauge). Generated by generate_aot_kernels -- regenerate after adding the esp_baked entries.
template <class Real, int MaxVecLen>
